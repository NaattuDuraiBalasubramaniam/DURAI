...
<div id="accordion" class="panel-group">
	<div id="propertydiv" class="accord-content">
		...
		&nbsp;&nbsp; 
			<!-- <button type="button" class="btn btn-info"  id="btnpropertydivPrint" ><i class="fa fa-file-pdf-o "></i><span>&nbsp;PDF&nbsp;</span></button> -->
		</div>
		<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
		&nbsp;&nbsp;
						<button type="button"  class="btn btn-info delRow-icon1"  id="powncpfDRow"><i class="fa fa-trash"></i><span>&nbsp;Delete</span></button>
  				 </div>
  				 <div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="powncpfERow"><i class="fa fa-edit"></i><span>&nbsp;Edit</span></button>
  				 </div>
				<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="powncpfARow"><i class="fa fa-plus"></i><span>&nbsp;Add</span></button>
  				 </div>
	...
	<input type="hidden" name="hiddenFormDlgPropOwnship" id="hiddenFormDlgPropOwnship" class="form-control" maxlength="150"> 
	</div>
