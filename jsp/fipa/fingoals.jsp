...
<div id="goalssection" >  
   ...
   <div class="panel-body"> 
		<img src="images/menuicons/goals.png" class="img-rounded" width="40" height="40" />&nbsp;<span class="panelHeaderTitle"> Financial Goals/ Concerns</span>
		...
		&nbsp;&nbsp;
						<button type="button"  class="btn btn-info delRow-icon1"  id="DfinGls"><i class="fa fa-trash"></i><span>&nbsp;Delete</span></button>
  				 </div>
  				 <div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="EfinGls"><i class="fa fa-edit"></i><span>&nbsp;Edit</span></button>
  				 </div>
				<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="AfinGls"><i class="fa fa-plus"></i><span>&nbsp;Add</span></button>
  				 </div>
...
<!-- 								<th>Priority</th>   -->
				 ...
				 <div class="clearspace40"></div> 
      				 <!--  Wealth Accumulation Goals   --> 
      				   ...
      				   <div class="panel-body"> 
		<img src="images/menuicons/wealthgoals.png" class="img-rounded" width="40" height="40" />&nbsp;	<span class="panelHeaderTitle"> Wealth Accumulation Goals</span>
		...
		<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
		&nbsp;&nbsp;
						<button type="button"  class="btn btn-info delRow-icon1"  id="WAcDRow"><i class="fa fa-trash"></i><span>&nbsp;Delete</span></button>
  				 </div>
  				 <div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="WAcERow"><i class="fa fa-edit"></i><span>&nbsp;Edit</span></button>
  				 </div>
				<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="WAcARow"><i class="fa fa-plus"></i><span>&nbsp;Add</span></button>
  				 </div>
