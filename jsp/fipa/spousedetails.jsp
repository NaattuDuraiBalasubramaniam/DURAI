...
<div id="spousesection">
 <div class="panel-body"> 
  ...
  <span class="panelHeaderTitle"> <input type="text" name="updlstdateSps" id="updlstdateSps" class="txtlastupdated" readonly="true"/ style="outline: none;"> </span>
		<span class="pull-right" style="margin-right: 10px"> 
			<!-- <button type="button" class="btn btn-info "  id="btnspouseinformationPrint" ><i class="fa fa-file-pdf-o "></i><span>&nbsp;PDF&nbsp;</span></button> -->
		<button type="button" class="btn btn-info" id="btnSpousePrint" style="margin-left: 0%;" >
			 						<span>&nbsp; SNA Spouse Report&nbsp;</span><i class=""></i></button>
		</span>
	...
	<fieldset class="fieldsetClsborder" id="spouseinformation">
    	<!-- <legend class="customFIPAStyle"><span><img alt="" src="images/menuicons/ClientSps.png" height="30" width="30"></span> Spouse Information</legend> -->
	  		...
	  		<span class="custompanelHeaderTitle"><small>Spouse Information</small></span>  
    		</div>
			 ...
			 <div class="row">
                ...
                Date of Birth<small>(DD/MM/YYYY)</small> <span class="mandFldastrks">*</span> </label>
                  ...
                  <input type='text' class="form-control clsfipaSpouse" id="dfSpsDob"   
 						name="dfSpsDob"    onmouseover="fipaTooltip(this);"
 					  maxlength="10"    >  
				...
				<div class="form-group"> 
				 ...
				 <input id="dfSpsAge" name="dfSpsAge" readonly="true"   onmouseover="fipaTooltip(this);"
			 ...
			 <div class="form-group required">
			   <div class="row">
                  ...
                  name="dfSpsNationality"   onmouseover="fipaTooltip(this);"> 
                ...
                <div class="form-group required"> 
                  ...
                  onchange="focusId(this,dfSpsNric)"  onmouseover="fipaTooltip(this);" >
				  ...
				  <div class="col-md-3 col-sm-3 col-xs-3"> 
				  	 <input id="dfSpsNric" name="dfSpsNric"   onmouseover="fipaTooltip(this);"
                 ...
                 <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-3">
                  <select class="form-control clsfipaSpouse" id="dfSpsGender" name="dfSpsGender"  onmouseover="fipaTooltip(this);" >
				 						<option value="">--SELECT--</option>
				 ...
				 <select class="form-control clsfipaSpouse" id="dfSpsMartsts" 
				 				name="dfSpsMartsts"   onmouseover="fipaTooltip(this);">
				...
				name="dfSpsSrcfund"  onmouseover="fipaTooltip(this);" >
				 						<option value="">--SELECT--</option>
				...
				<select class="form-control clsfipaSpouse" id="dfSpsSmoking" name="dfSpsSmoking"  onmouseover="fipaTooltip(this);" >
				 						<option value="">--SELECT--</option>
     ...
     <fieldset class="fieldsetClsborder">
    	<!-- <legend class="customFIPAStyle"><span><img alt="" src="images/menuicons/ContactInfo.png" height="30" width="30"></span>Contact Information</legend>         -->
                ...
                <div class="form-group">  
				 ...
				 <div class="col-md-4 col-sm-4 col-xs-4">
			<input id="dfSpsHp" name="dfSpsHp"  class="form-control clsfipaSpouse"   type="text"   onmouseover="fipaTooltip(this);"
			 maxlength="60"   onmouseover="fipaTooltip(this);"   />
                ...
                <div class="form-group">  
                 <div class="row">
                  ...
                  <label class="control-label pull-right text-right" for="dfSpsHome">Home  </label>
				    ...
				    <div class="col-md-4 col-sm-4 col-xs-4">
				<input id="dfSpsHome" name="dfSpsHome"  class="form-control clsfipaSpouse"    onmouseover="fipaTooltip(this);"
                ...
                <label class="control-label pull-right text-right" for="dfSpsOffice">Office </label>
				   ...
				   <div class="col-md-4 col-sm-4 col-xs-4"> 
                <input id="dfSpsOffice" name="dfSpsOffice"  class="form-control clsfipaSpouse"   onmouseover="fipaTooltip(this);"
                type="text"  maxlength="60"  />
                </div>
                </div>
                </div>
                ...
                <div class="row">
				  ...
				  <div class="col-md-4 col-sm-4 col-xs-4">
				<input id="dfSpsFax" name="dfSpsFax"   class="form-control clsfipaSpouse"   onmouseover="fipaTooltip(this);"
				type="text"  maxlength="60"  />
                </div>
                </div>
                </div>
   ...
   <fieldset class="fieldsetClsborder">
    <!-- 	<legend class="customFIPAStyle"><span><img alt="" src="images/menuicons/ClientEmp.png" height="30" width="30"></span>Employment Info</legend> -->
    	        <div class="panel-heading" style="background-color: #1D655C;">
                 ...
                 <div class="row">
                  ...
                  <label class="control-label pull-right text-right" for="dfSpsEmpsts">Employment Status  </label>
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-4">
				<select class="form-control clsfipaSpouse" id="dfSpsEmpsts" name="dfSpsEmpsts"  onmouseover="fipaTooltip(this);"  >
				 						<option value="">--SELECT--</option>
                 ...
                 <div class="form-group">  
                  <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                  <input id="dfSpsOccpn" name="dfSpsOccpn" class="form-control clsfipaSpouse"  onmouseover="fipaTooltip(this);"
                   type="text" maxlength="60"   />
				</div>
				</div>
				 </div>
                ...
                <div class="form-group">   
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-6">
				<input id="dfSpsCompname" name="dfSpsCompname" class="form-control clsfipaSpouse"  onmouseover="fipaTooltip(this);"
				type="text" maxlength="60"    />
                </div>
                </div>
                </div>
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
				<select class="form-control clsfipaSpouse" id="dfSpsempcat" name="dfSpsempcat"   onmouseover="fipaTooltip(this);"> 
				<option value="">--SELECT--</option>
                ...
                <input type="text" name="dfSpsAnnlincome"  id="dfSpsAnnlincome"  onmouseover="fipaTooltip(this);"
                onmouseover="fipaTooltip(this);"
...
<!--                 class="clsfipaSpouse" -->
               ...
               <div class="col-md-4 col-sm-4 col-xs-4">
<!--                clsfipaSpouse -->
                <select class="form-control clsfipaSpouse" id="dfSpsHomecntry" name="dfSpsHomecntry"   onmouseover="fipaTooltip(this);"
...
<!--                 class="clsfipaSpouse" -->
				...
				<div class="checkbox checkbox-primary">
                       <input type="checkbox" id="dfSpsMailaddrAsSelf" name="dfSpsMailaddrAsSelf"  onmouseover="fipaTooltip(this);"
				    onclick="setChkBoxValue(this)"   /> 
...
<!-- 				 disabledCursor clearfipaSpouse -->
              <select class="form-control disabledCursor" id="dfSpsMailcntry" name="dfSpsMailcntry"  onmouseover="fipaTooltip(this);"
                disabled="true">
				 						<option value="">--SELECT--</option>
				 					<option value="SINGAPORE">SINGAPORE</option>
				 						<c:if test="${not empty COUNTRIES}">
               ...
               <div class="col-md-4 col-sm-4 col-xs-4">
				...
				<div class="col-md-8 col-sm-8 col-xs-8">
				<select class="form-control disabledCursor clearfipaSpouse" id="dfSpsAddrreason"  onmouseover="fipaTooltip(this);"
