      ...
      <div class="font_dialogbox" id="listofLifeIns_Dialog">
        <div class="nav-tabs-custom">
          <ul class="nav nav-pills-blue navbar-static-top navg-bar" id="lifeInsNavTabsDets">
            ...
            <li class="pull-right">
            	<span class="popupheader">
            		<img src="images/menuicons/canvas.png" class="info" width="15" >
            		<small>  All fields marked with <sup>*</sup> are required</small>
            	</span>
            </li>
          ...
          <div class="tab-content">
            <!-- ****************************************************** Existing Policy Tab ************************************************ -->
            <div class="tab-pane active fade in" id="existPolicyDetstab" style="height:133vh">
              <div class="col-md-12"> 
                ...
                </small> <button type="button" class="btn btn-primary floatbtn rp-cf-btn-float hidden" id="btnSavePolicyPlan">
              ...
              <div class="col-md-12">
                ...
                <div class="btn-group" role="group">
                  ...
                  <a class="btn btn-default addlifeicon" id="backToFdFlowLife"  onclick="openBackToFundFlow('expdSelfInsurance');"></a>
                </div>
              </div>
              ...
              <fieldset class="fieldsetClsborder">
                <div id="LIFE_APD" >
                  <div id="lifeMandatoryFlds">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6 cvbgcync">
                     <table class="table hover no-border">
                      <tbody>
                        <tr>
                          <td class="cvborder-topbottom-head ">
                            <div class="height5vh">
                                 <!--  <label for="" class="text-right">Owner / Proposed* </label>&nbsp;<a class="btn btn-default pull-right genAddBProicon" id="genBasicicon" data-hasqtip="179"></a>  -->
                                  <label for="" class="text-right" for="lipOwner">Owner / Proposed*<span style="color:white;font-weight:bold;"></span></label> 
                            </div>
                          </td>
                        </tr>
                        <tr>
                          <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                 <label for="" class="text-right" for="lipAssured">Life Assured* </label>&nbsp;<a class="btn  pull-right addinfoicon btn-default" id="poplipAssured" data-hasqtip="179" ></a> 
                            </div>
                          </td>
                        </tr>
                         <tr>
                          <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="lipCompany"> Insurance Company*<span style="color:white;font-weight:bold;"></span></label> 
                            </div>
                          </td>
                        </tr>
                        <tr>
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="lipPolicyno">Policy No.*<span style="color:white;font-weight:bold;"></span></label> 
                            </div>
                          </td>
                       </tr>
                        <tr>
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="policyStatus">Policy Status*<span style="color:white;font-weight:bold;"></span></label> 
                           </div>
                          </td>
                       </tr>
                        <tr>
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="lipPlantype">Type of Plan<span style="color:white;font-weight:bold;"></span></label> 
                            </div>
                          </td>
                       </tr>
                       <tr>
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="lipIncepdate">Inc. Date of policy<span style="color:white;font-weight:bold;"></span><small>(DD/MM/YYYY)</small>*</label> 
                           </div>
                          </td>
                       </tr>
                        <tr>
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="lipExpdate">Expiry Date<span style="color:white;font-weight:bold;"></span><small>(DD/MM/YYYY)</small>*</label> 
                            </div>
                          </td>
                       </tr>
                        <tr>
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="lipPaymentfreq">Frequency of payments<span style="color:white;font-weight:bold;"></span></label> 
                            </div>
                          </td>
                       </tr>
                       <tr>
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="lipPaymentmethod">Payment method<span style="color:white;font-weight:bold;"></span></label> 
                            </div>
                          </td>
                       </tr>
                        <tr>
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="lipPremiumsrc">Source of Premium<span style="color:white;font-weight:bold;"></span></label> 
                            </div>
                          </td>
                       </tr>
                       <tr>
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="lipSa"> Sum Assured<span style="color:white;font-weight:bold;"></span></label> 
                            </div>
                          </td>
                       </tr>
                     <!--  <br> -->
                  ...
                  <div class="col-md-3 ">
                     <table class="table hover no-border lifeinssecondcol">
                      <tbody>
                        <tr style="height: 6vh;">
                          <td >
                            <div >
                        ...
                        <td >
                             <div class="input-group input-group-sm">
                              ...
                              <input type="text" onmouseover="fipaTooltip(this);"
                                name="lipSa" id="lipSa"
                                class="form-control numbers applyEvntUsd fld-resp-mm" />
                            </div>
                          </td>
                        </tr>
                      </tbody>
                      ...
                      <tbody>
                        <tr>
                          <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                 <!--  <label for="" class="text-right">Owner / Proposed* </label>&nbsp;<a class="btn btn-default pull-right genAddBProicon" id="genBasicicon" data-hasqtip="179"></a>  -->
                                  <label for="" class="text-right" for="lipPlanname"> Name of Main Plan<span style="color:white;font-weight:bold;"></span></label> 
                    </div>
                          </td>
                        </tr>
                        <tr>
                          <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                 <label for="" class="text-right" for="sellipCoveragetype">Types of benefit / Coverage <span style="color:white;font-weight:bold;"></span></label> 
                            </div>
                          </td>
                        </tr>
                         <tr>
                          <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="sellipIsnurObject"> Obj. of Insurance<span style="color:white;font-weight:bold;"></span></label> 
                            </div>
                          </td>
                        </tr>
                        <tr>
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="lipCurrBonusAcc">Current Bonus accumulation<span style="color:white;font-weight:bold;"></span></label> 
                            </div>
                          </td>
                       </tr>
                        <tr>
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="lipCurrCashVal"> Current Cash Value<span style="color:white;font-weight:bold;"></span></label> 
                           </div>
                          </td>
                       </tr>
                        <tr>
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="lipMaturityVal">Maturity Value<span style="color:white;font-weight:bold;"></span></label> 
                            </div>
                          </td>
                       </tr>
                       <tr>
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="lipMaturityDate">Maturity Date<span style="color:white;font-weight:bold;"></span><small>(DD/MM/YYYY)</small>*</label> 
                           </div>
                          </td>
                       </tr>
                        <tr>
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="osLoan">Outstanding Loan <span style="color:white;font-weight:bold;"></span></label> 
                            </div>
                          </td>
                       </tr>
                        <tr>
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="nominationType">Types Of Nominee<span style="color:white;font-weight:bold;"></span></label>&nbsp;<a class="btn btn-default pull-right addinfoicon" id="popnominationType"  ></a> 
                            </div>
                          </td>
                       </tr>
                       <tr>
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="selThirdPartName">Third Party Name<span style="color:white;font-weight:bold;"></span></label> 
                            </div>
                          </td>
                       </tr>
                        ...
                        <td class="cvborder-topbottom-head">
                            <div class="height5vh">
                                  <label for="" class="text-right" for="lipRemarks">Remarks<span style="color:white;font-weight:bold;"></span></label> 
                            </div>
                          </td>
                       </tr>
                      </tbody>
   		  ...
   		  <input name="txtFldLifeInsLoans" id="txtFldLifeInsLoansB00"  class="form-control fld-resp-sm numbers applyEvntUsd" type="text"  onmouseover="fipaTooltip(this);" onchange="onchangePlanMode(this)">
                ...
                <div id="PLANCOV_APD"  >
                  <div id="plancovMandatoryFlds">
                    ...
                    <table class="table table-bordered display hover" style="min-width:35%;max-width:55%;margin-right: auto;margin-left: auto;text-align-last:left;">                    	
                    	<tbody>                        
                        <tr>
                          <td align="right" style="width:15% !important;"><strong>Plan Name :</strong> </td>
                          <td colspan="5"><span class='control-label' id='covPlanName'></span></td>
                        </tr>
                        <tr>
                          <td align="right" style="width:15% !important;"><strong>Type of Benefit :</strong> </td>                          
                          <td  colspan="5"><span class='control-label  ' id='covTypeofbenefit'></span></td>
                        </tr>
                        <tr>
                          <td align="right" style="width:15% !important;"><strong>Basic/Rider :</strong> </td>
                          <td style="width:10% !important;"><span class='control-label  ' id='covBasicRider'></span></td>
                          
                          <td align="right" style="width:15% !important;"><strong>Inception Date :</strong> </td>
                          <td style="width:10% !important;"><span class='control-label  ' id='covInception'></span></td>
                          
                          <td align="right" style="width:15% !important;"><strong>Expiry Date :</strong> </td>
                          <td style="width:10% !important;"><span class='control-label' id='covExpiry'>
                            </span>
                     ...
                     <table id="plancoveragetbl" class="dataTable table-bordered display hover " style="width:40%;min-width:40%" >
                       <thead>
                         <tr>
                           <th style="color: #fff;width:18%"  class="coverageTh" >
...
<!--                               --> 
	                          ...
	                          <tbody>
	                            <tr>
	                              <td  class="coverageTh selectedd cvbgcync" align="left">
	                            ...
	                            <tr>
	                              <td  class="coverageTh cvbgcync" align="left">
	                                <div style="width:200px;">
        ...
        <fieldset class="fieldsetClsborder scrollModelBody60">
          ...
          <div class="row col-md-12">
            <div class="form-group">
              ...
              <div class="table-responsive">
                <table id="liEduPayoutstbl_900" class="dataTable table-bordered table-striped display hover" style="width: 100%">
                  <thead class="fipaFldLblTextbold">
                    <tr>
                      <th>#</th>
                      <th>Select</th>
