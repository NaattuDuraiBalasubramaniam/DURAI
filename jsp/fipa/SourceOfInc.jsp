...
<ul id="incomeexpd" class="nav nav-pills fipa_common_tab" role="tablist"	data-tabs="tabs" style="height: 30px">
	<li class="active"><a href="#incomeparticulars" data-toggle="tab">
			
				<label class="tablabel" for="IncomeTab"><i class="fa fa-money" title="Income"></i>&nbsp;&nbsp;&nbsp;&nbsp;Income</label>
	</a></li>
	<li><a href="#expenseParticulars" data-toggle="tab"> 
	
	 <label  class="tablabel" for="ExpensesTab"><i class="fa fa-calculator" title="Expenses"></i>&nbsp;&nbsp;&nbsp;&nbsp;Expenses</label>
	</a></li>

	<li><a href="#incomeexpchartParticulars" data-toggle="tab"> 

		<label  class="tablabel" for="IncExpChartTab"><i class="fa fa-pie-chart" title="Income & Expenses chart"></i>&nbsp;&nbsp;&nbsp;&nbsp;Chart</label>
	</a></li>
...
<div class="tab-content">
	<div role="tabpanel" class="tab-pane fade in active" id="incomeparticulars">
	
	<div class="panel-body">
	<!-- <button type="button" class="btn btn-info" id="btnCpfPrint" style="margin-left: 75%;" onclick="window.open('http://localhost:8080/FIPAM/CashFlowReport.do#')">
			 						<span>&nbsp;PDF&nbsp;</span><i class=""></i></button> -->
			<button type="button" class="btn btn-info" id="btnCpfPrint" style="margin-left: 75%;" >
			 						<span>&nbsp;Income Expenses Report&nbsp;</span><i class=""></i></button> 
			 							 						
		<div id="sourceincomediv" >
				...
				<table class="display nowrap table  table-bordered "  id="tblssourceofincome"> 
					...
					<td rowspan="3">
							...
							<input  type="text" class="form-control numbers clsfipaClient applyEvntUsd" 
						      	name="incsrcSelfEmpMonthly" id="incsrcSelfEmpMonthly"  onmouseover="fipaTooltip(this);"
							...
							<div class="input-group input-group-sm fld-resp-md" >
							    ...
							    name="incsrcSpsEmpMonthly" id="incsrcSpsEmpMonthly"  onmouseover="fipaTooltip(this);"
							...
							<div class="input-group input-group-sm fld-resp-md" >
							    ...
							    name="incsrcJointEmpMonthly" id="incsrcJointEmpMonthly"  onmouseover="fipaTooltip(this);"
					...
					<td valign="middle">
							...
							<input type="text"  class="form-control numbers clsfipaClient applyEvntpCent" 
						      	name="incsrcSelfEmpIncr" id="incsrcSelfEmpIncr"  onmouseover="fipaTooltip(this);"
						      	></input>
								 <div class="input-group-addon" > 
						...
						<td>   
							...
							<input type="text"  class="form-control numbers clsfipaSpouse applyEvntpCent" 
						      	name="incsrcSpsEmpIncr" id="incsrcSpsEmpIncr"  onmouseover="fipaTooltip(this);"
						      	/>
							 <div class="input-group-addon" > 
							  <span class="glyphicon" id="symbolprCent"></span> </div>
						 </div> 
					...
					<td>   
							...
							<div class="input-group input-group-sm fld-resp-sm" > 
							<input type="text"  class="form-control numbers clsfipaFamily applyEvntpCent"  onmouseover="fipaTooltip(this);"
					...
					<td valign="middle">
							...
							<div class="input-group input-group-sm fld-resp-sm" > 
								...
								name="incsrcSelfEmpPeriod"  onmouseover="fipaTooltip(this);"
							...
							<div class="input-group input-group-sm fld-resp-sm" > 
							    ...
							    name="incsrcSpsEmpPeriod" id="incsrcSpsEmpPeriod"  onmouseover="fipaTooltip(this);"
						...
						<td>
							...
							<div class="input-group input-group-sm fld-resp-sm" > 
							    ...
							    name="incsrcJointEmpPeriod" id="incsrcJointEmpPeriod"  onmouseover="fipaTooltip(this);"
					...
					<tr valign="top">  
						<td rowspan="3">&nbsp;</td> 
							...
							<input type="text"  class="form-control numbers clsfipaClient applyEvntUsd" 
						      	name="incsrcSelfEmpAddlwage" id="incsrcSelfEmpAddlwage"   onmouseover="fipaTooltip(this);"
							...
							<div class="input-group input-group-sm fld-resp-md" >
								<div class="input-group-addon" > 
								  <span class="glyphicon" id="symbolUsd"></span> </div>
								  <input type="text"  class=" form-control fld-resp-sm numbers clsfipaSpouse applyEvntUsd"
							    name="incsrcSpsEmpAddlwage" id="incsrcSpsEmpAddlwage"  onmouseover="fipaTooltip(this);"
				...
				<col width="5%">
					...
					<td rowspan="7">
							...
							<input type="text"  name="incsrcSelfNempMonthly" id="incsrcSelfNempMonthly"
							    class=" form-control fld-resp-md numbers clsfipaClient applyEvntUsd"  onmouseover="fipaTooltip(this);"
							...
							<td>
								...
								class=" form-control fld-resp-md numbers clsfipaSpouse applyEvntUsd"  onmouseover="fipaTooltip(this);"
							    onchange="calcSum(null,SrcOF_Inc.SRCOFINCM_SPS);"
								 ></input>
								 </div>
							</td>
							...
							<div class="input-group input-group-sm fld-resp-md" >
							    ...
							    name="incsrcJointNempMonthly" id="incsrcJointNempMonthly"  onmouseover="fipaTooltip(this);"
								onchange="calcSum(null,SrcOF_Inc.SRCOFINCM_JOINT);"
								 ></input>
							 </div>
							</td>
					...
					<tr valign="top">
						...
						<td valign="middle">
							...
							<td>   
								...
								class=" form-control fld-resp-md numbers clsfipaClient applyEvntUsd autoAlt"    onmouseover="fipaTooltip(this);"
								onchange="calcSum(null,SrcOF_Inc.SRCOFINCM_SLF);"
						...
						<td>
								...
								class=" form-control fld-resp-md numbers clsfipaSpouse applyEvntUsd autoAlt"  onmouseover="fipaTooltip(this);"
								onchange="calcSum(null,SrcOF_Inc.SRCOFINCM_SPS);"
								></input>
								</div>
								</td>		
						...
						<td>
							...
							name="incsrcJointNempRentamt" id="incsrcJointNempRentamt"  onmouseover="fipaTooltip(this);"
							onchange="calcSum(null,SrcOF_Inc.SRCOFINCM_JOINT);"
							></input>
							</div>
							</td>
					 ...
					 <tr valign="top">
						...
						<td>
							...
							<span class="glyphicon" id="symbolUsd"></span> </div>
							<input type="text"  class=" form-control fld-resp-md numbers clsfipaFamily applyEvntUsd autoAlt"
							name="incsrcJointNempDivdamt" id="incsrcJointNempDivdamt"  onmouseover="fipaTooltip(this);"
							onchange="calcSum(null,SrcOF_Inc.SRCOFINCM_JOINT);"
							></input>
							</div>
							</td>
					...
					<tr valign="top">
						...
						<td>
							...
							<span class="glyphicon" id="symbolUsd"></span> </div>
							<input type="text"  class=" form-control fld-resp-md numbers clsfipaFamily applyEvntUsd"
							name="incsrcJointNempOthamt" id="incsrcJointNempOthamt"   onmouseover="fipaTooltip(this);"
							onchange="calcSum(null,SrcOF_Inc.SRCOFINCM_JOINT);"
							></input>
							</div>
						</td>
						...
						<td valign="middle">
							...
							<td>   
								...
								class="form-control fld-resp-md numbers readOlyCursor clearfipaClient applyEvntUsd"  onmouseover="fipaTooltip(this);"
								readonly="true"
								></input>
								</div>
								</td>
							...
							<td>
								...
								id="insrcSpsTotannl" 
								class="form-control numbers readOlyCursor clearfipaSpouse applyEvntUsd"  onmouseover="fipaTooltip(this);"
								readonly="true"></input>
								</div>
								</td>		
						...
						<td>
							...
							<div class="input-group-addon" > 
							<span class="glyphicon" id="symbolUsd"></span> </div>
							<input type="text"  class="form-control numbers readOlyCursor applyEvntUsd"  onmouseover="fipaTooltip(this);"
						...
						<td valign="middle">
							...
							<td>   
								...
								<input type="text"  name="incsrcSelfAbility" id="incsrcSelfAbility"  onmouseover="fipaTooltip(this);"
						...
						<td>
								...
								<input type="text"  name="incsrcSpsAbility" id="incsrcSpsAbility"  onmouseover="fipaTooltip(this);"
						...
						<td>
							...
							<div class="input-group-addon" > 
							<span class="glyphicon" id="symbolUsd"></span> </div>
							<input type="text"  class=" form-control fld-resp-md numbers clsfipaFamily applyEvntUsd"  onmouseover="fipaTooltip(this);"
					...
					<td valign="middle">
						 ...
						 <td>   
							<div class="input-group input-group-sm fld-resp-sm" > 
							<input type="text"  class="form-control numbers clsfipaClient applyEvntpCent"  onmouseover="fipaTooltip(this);"
						...
						<td>   
							<div class="input-group input-group-sm fld-resp-sm" > 
							<input type="text"  class="form-control numbers clsfipaSpouse applyEvntpCent"  onmouseover="fipaTooltip(this);"
					...
					<label class="fipaFldLblText" style="text-align: left;">
								Remarks</label>
				<textarea name="incsrcRemarks" id="incsrcRemarks" rows="2" class="form-control"  onmouseover="fipaTooltip(this);"
	...
	<div role="tabpanel" class="tab-pane fade" id="expenseParticulars">
	
	<div class="panel-body">
	
	<span class="panelHeaderTitle"> Annual Expenditure - Outflow </span>
		<span class="fipaFldLblText" style="text-align: left;">
...
<fieldset class="fieldsetClsborder">
				<table id="tblannlexpre" class="display nowrap table table-borderless"   > 
					...
					<thead>
					 ...
					 <div class="input-group input-group-sm" style="width:200px"> 
							...
							class="form-control fld-resp-md numbers clsfipaFamily applyEvntUsd"  onmouseover="fipaTooltip(this);"
						...
						<tr>
							...
							<input type="text" name="expdSelfUtil"   id="expdSelfUtil" 
							  class="form-control fld-resp-sm numbers clsfipaClient applyEvntUsd"  onmouseover="fipaTooltip(this);"
							...
							class="form-control fld-resp-sm numbers clsfipaSpouse applyEvntUsd"  onmouseover="fipaTooltip(this);"
							...
							<input type="text" name="expdFamilyUtil"   id="expdFamilyUtil"  
							 class="form-control fld-resp-sm numbers clsfipaFamily applyEvntUsd"  onmouseover="fipaTooltip(this);"
							 onchange="calcSum(this,'SUMOF_ANNEXP_FAM')"></input>
							</div>
							</td>
						</tr>
						...
						<img src="images/menuicons/med.png" height="60" width="60" />
							...
							<input type="text" name="expdSpsMedical"   id="expdSpsMedical"    onmouseover="fipaTooltip(this);"
						...
						<tr><td rowspan="2" style="text-align: center">
							...
							<input type="text" name="expdSelfDepntcontr"   id="expdSelfDepntcontr" 
							  class="form-control fld-resp-sm numbers readOlyCursor clearfipaClient applyEvntUsd"  onmouseover="fipaTooltip(this);"
							...
							class="form-control fld-resp-sm numbers readOlyCursor clearfipaSpouse applyEvntUsd"  onmouseover="fipaTooltip(this);"
						...
						<tr> 
							...
							<div class="input-group input-group-sm" style="width:200px"> 
							 ...
							 <input type="text" name="expdSelfProploan"   id="expdSelfProploan" 
							   class="form-control fld-resp-sm numbers clsfipaClient applyEvntUsd autoAlt"   onmouseover="fipaTooltip(this);"
								onchange="calcSum(this,'SUMOF_ANNEXP_SELF')"></input>
							</div>
							</td>
							<td>
							<div class="input-group input-group-sm" style="width:200px"> 
							 ...
							 <input type="text" name="expdSpsProploan"   id="expdSpsProploan"  
							  class="form-control fld-resp-sm numbers clsfipaSpouse applyEvntUsd autoAlt"  onmouseover="fipaTooltip(this);"
							  onchange="calcSum(this,'SUMOF_ANNEXP_SPS')"></input>
							</div>
							</td>
							<td>
							<div class="input-group input-group-sm" style="width:200px"> 
							 ...
							 <input type="text" name="expdFamilyProploan"   id="expdFamilyProploan" 
							   class="form-control fld-resp-sm numbers clsfipaFamily applyEvntUsd autoAlt"  onmouseover="fipaTooltip(this);"
							   onchange="calcSum(this,'SUMOF_ANNEXP_FAM')"></input>
							</div>
							</td>
						</tr>
						...
						<div class="fipaFldLblText" style="text-align: right" >Life Insurance Premiums  
							...
							<div class="input-group input-group-sm" style="width:200px"> 
							 ...
							 <input type="text" name="expdSelfInsurance"   id="expdSelfInsurance"  
							  ...
							  <input type="hidden"  id="expdSelfInsuranceCACL"  
							  class="form-control fld-resp-sm numbers clsfipaClient applyEvntUsd autoAlt"  onmouseover="fipaTooltip(this);"
							  onchange="calcSum(this,'SUMOF_ANNEXP_SELF')"></input>
							</div>
							</td>
							...
							<div class="input-group input-group-sm" style="width:200px"> 
							 ...
							 <input type="hidden"    id="expdSpsInsuranceCACL"    
							 class="form-control fld-resp-sm numbers clsfipaSpouse applyEvntUsd autoAlt"   onmouseover="fipaTooltip(this);"
							 onchange="calcSum(this,'SUMOF_ANNEXP_SPS')"></input>
							</div>
							</td>
							...
							<div class="input-group input-group-sm" style="width:200px"> 
							 ...
							 <input type="hidden"  id="expdFamilyInsuranceCACL"    
							 class="form-control fld-resp-sm numbers clsfipaFamily applyEvntUsd autoAlt"  onmouseover="fipaTooltip(this);"
							 onchange="calcSum(this,'SUMOF_ANNEXP_FAM')"></input>
						...
						<tr><td></td>
							...
							<input type="text" name="expdSpsTotalannl"   id="expdSpsTotalannl"    onmouseover="fipaTooltip(this);"
							...
							<input type="text" name="expdFamilyTotalannl"   id="expdFamilyTotalannl"    onmouseover="fipaTooltip(this);"
	...
	<div role="tabpanel" class="tab-pane fade" id="incomeexpchartParticulars">
	...
	<div class="panel-body">
	            ...
	            <select id="chartTypeSelf" onchange="loadDynamicChartSelf();"  onmouseover="fipaTooltip(this);"> 
				 ...
				 <div class="col-md-6">	
   		         <div class="clearspace40"></div>
   		          <input type="text" name="detailsExpenseCharttittle" id="detailsExpenseCharttittle"  onmouseover="fipaTooltip(this);" style="color:#50907C;font-weight: bold;padding-left: 35%;border-bottom: none;font-size: 15px;" class="txttitlastupdated" readonly="readonly">
				...
				<div class="" id="">  
                 ...
                 <label style="margin-left: 10%;">Chart type :</label>
	            <select id="chartTypeSpouse" onchange="loadDynamicChartSpouse();"  onmouseover="fipaTooltip(this);"> 
	                <option value="Pie">Pie Chart</option>
	                <option value="Doughnut">Doughnut chart</option>
	            </select>
	            </div>
				 ...
				 <div class="col-md-6">	
   		         <div class="clearspace40"></div> 
   		          <input type="text" name="detailsExpenseSpouseCharttittle" id="detailsExpenseSpouseCharttittle"  onmouseover="fipaTooltip(this);" style="color:#50907C;font-weight: bold;padding-left: 35%;border-bottom: none;font-size: 15px;" class="txttitlastupdated" readonly="readonly">
			     <div style="width:auto;margin-left: -10%;">
	            ...
	            <select id="chartTypeJointFamily" onchange="loadDynamicChartJointFamily();"  onmouseover="fipaTooltip(this);"> 
	                <option value="Pie">Pie Chart</option>
	                <option value="Doughnut">Doughnut chart</option>
	            </select>
	            </div>
				 ...
				 <div class="col-md-6">	
   		         <div class="clearspace40"></div> 
   		          <input type="text" name="detailsExpenseJointCharttittle" id="detailsExpenseJointCharttittle"  onmouseover="fipaTooltip(this);" style="color:#50907C;font-weight: bold;padding-left: 35%;border-bottom: none;font-size: 15px;" class="txttitlastupdated" readonly="readonly">
			     <div style="width:auto;margin-left: -10%;">
...
<div class="modal fade"  id="lifeInsurancePremiums" style="display: none;z-index:1070" 
  ...
  <div class="modal-dialog alertModelContent modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align: center;">
       <div id="confalertimglife" style="display: inline;"></div><!-- aravindh -->
      <div id="confalertmsglife"  style="display: inline-block;"></div> <!-- aravindh -->
