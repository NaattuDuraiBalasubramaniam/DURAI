...
<div id="accordion" class="panel-group">   
  ...
  <input type="text" name="updlstdatefrAttach" id="updlstdatefrAttach" class="txtlastupdated" readonly="true"/>
      ...
      <img src="images/menuicons/canvas.png" width="15" class="info" data-hasqtip="22" aria-describedby="qtip-22">
		...
		&nbsp;&nbsp;
						<button type="button"  class="btn btn-info delRow-icon1"  id="DcAttchDRow"><i class="fa fa-trash"></i><span>&nbsp;Delete</span></button>
  				 </div>
				<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="DcAttchARow"><i class="fa fa-plus"></i><span>&nbsp;Add</span></button>
  				 </div>
