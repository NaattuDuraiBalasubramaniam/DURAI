...
<div class="pull-right" role="group" >
		&nbsp;&nbsp; 
			<button type="button"  style="display: none;" class="btn btn-info"  id="btninputinvstsectionPrint" ><i class="fa fa-file-pdf-o "></i><span>&nbsp;PDF&nbsp;</span></button>
		
		<button type="button" class="btn btn-info" id="btnInversementPrint" style="">
			 						<span>&nbsp;Investment Report&nbsp;</span><i class=""></i></button>
		...
		&nbsp;&nbsp;
						<button type="button"  class="btn btn-info delRow-icon1"  id="InvestDRow"><i class="fa fa-trash"></i><span>&nbsp;Delete</span></button>
  				 </div>
  				 <div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="InvestERow"><i class="fa fa-edit"></i><span>&nbsp;Edit</span></button>
  				 </div>
				<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="InvestARow"><i class="fa fa-plus"></i><span>&nbsp;Add</span></button>
  				 </div>
				...
				<!-- <table id="fnaInvestmentTbl" class="dataTable table-bordered table-striped display hover" style="width: 100%">
					 <thead  valign="top"> 
							...
							<tr>
								...
								<th><div style="width:100px">Basis of Disbursement</div></th>
					...
					<tbody></tbody>
					 ...
					 <thead> 
							<tr>
								...
								<th style="width: 28px;"><div  class="checkbox checkbox-primary text-center" style="width: 28px;"><input type="checkbox" id="SelfnaInvestment" name="SelfnaInvestment" onclick="SelAllSelfnaInvestment(this)"><label for="SelfnaInvestment">&nbsp;</label></div></th>
							    <th style="width: 60px;"><div style="width: 60px;">Ownership</div></th>
							    <th style="width: 80px;"><div style="width: 80px;">Types of Investment</div></th>
								<th style="width: 150px;"><div style="width: 150px;">Description</div></th>
								<th style="width: 70px;"><div style="width: 70px;">Amount Invested</div></th> 
								<th style="width: 70px;"><div style="width: 70px;">Current NAV</div></th>
								<th style="width: 70px;"><div style="width: 70px;">Annual Dividend</div></th>
								<th style="width: 100px;"><div style="width: 100px;">RSP</div></th>
								<th style="width: 80px;"><div style="width: 80px;">Objective</div></th>
								<th style="width: 100px;"><div style="width: 100px;">Disbursement Plan</div></th>
							  </tr>
					</thead>
					<tbody></tbody>
					</table>
					<input type="hidden" name="hiddenFormDlgInvDesc" id="hiddenFormDlgInvDesc" class="form-control" maxlength="150"> 
					</div> 
					</div>
...
<div class="modal fade" id="Investment_Dialog" style="display: none;"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog scrollModelBodyWidth1300" role="document">
    <div class="modal-content">
     ...
     <fieldset class="fieldsetClsborder scrollModelBody60" style="max-height: 83vh;padding: 0px;">
      <div class="clearspace20" style="height: 5px;"></div>
    <!-- 	dlgBdyWidth450 -->
		<div class="col-md-4"> 
	
     <!--  <fieldset  id="investment_details"> -->
	...
	<div class="col-md-6 col-sm-6 col-xs-6 "> 
             <legend class="customFIPAStyle control-label pull-right text-right" style="color: #243665;">Investment Details</legend>
             </div> 
           <div class="col-md-6 col-sm-6 col-xs-6"> 
...
<!-- 				PORTFOLIO_CATG_LIST -->
	...
	<div class=" "  style="width: 180px;"> 
             <legend class="customFIPAStyle control-label pull-right text-right" style="color: #243665;">Regular Investment Plan (RSP)</legend>
             </div> 
	...
	<div class="col-md-6 col-sm-6 col-xs-6 "> 
            <label class="control-label pull-right text-right" 
                   ...
                   Years Of Regular Investment </label>	
				</div>
				<div class="col-md-6 col-sm-6 col-xs-6 "> 
				<div class="input-group input-group-sm fld-resp-sm">
	...
	<div class="row" > 
	<div class="col-md-6 col-sm-6 col-xs-6 "> 
             <legend class="customFIPAStyle control-label pull-right text-right" style="color: #243665;height: 5px;">NAV Details</legend>
             </div> 
           <div class="col-md-6 col-sm-6 col-xs-6"> 
      ...
      <div class="form-group"> 
        <!-- <fieldset  id="invNav_details"> -->
        
      	<div>
		<div class="form-group">
	<div class="row" > 
	<div class="col-md-6 col-sm-6 col-xs-6 "> 
             <label class="control-label  pull-right text-right" for="txtFldDlgInvDateInvst">
                Date Invested  <span class="mandFldastrks">*</span>
               </label>
             </div> 
           <div class="col-md-6 col-sm-6 col-xs-6"> 
	...
	<div class="col-md-6 col-sm-6 col-xs-6"> 
		...
		<div class="input-group input-group-sm">
				       <div class="input-group-addon">
				       <span class="glyphicon" id="symbolUsd"></span> </div>
                <input type="text" name="txtFldDlgInvCurBid" style="width: 77px; " onmouseover="fipaTooltip(this);"  
	...
	<div class="col-md-6 col-sm-6 col-xs-6"> 
      ...
      <!-- <div class="form-group"> -->
      <!-- <fieldset  id="dividendDets"> -->
      
      	<div style="min-height: 327px;">
     <!--  <div class="col-md-12">  --> 
    
         <div class="" id="invAnlDivid"><!-- row style="display:none" -->
	...
	<div class="row" > 
	<div class="col-md-6 col-sm-6 col-xs-6 "> 
             <legend class="customFIPAStyle control-label pull-right text-right" style="color: #243665;">Dividend Details</legend>
             </div> 
           <div class="col-md-6 col-sm-6 col-xs-6"> 
...
<!--                 		</div>                -->
	...
	<div class="col-md-6 col-sm-6 col-xs-6"> 
            <label class="control-label pull-right text-right" for="selDlgDividendAmt">
                  Dividend Amount per Annum<a class="btn btn-default addinfoicon" id="popselDlgDividendAmt"  ></a>
				</label>
             </div> 
           <div class="col-md-6 col-sm-6 col-xs-6"> 
		<div class="input-group input-group-sm">
      ...
      <!-- <fieldset  id="investmentobj"> --> 
     
      <div class="col-md-12" style="min-height: 255px;">  
      <div class="form-group">
	<div class="row" > 
	<div class="col-md-6 "> 
             <legend class="customFIPAStyle  control-label pull-right text-right" style="color: #243665;height: 5px;">Investment Objective</legend>
             </div> 
           <div class="col-md-6 "> 
	...
	<div class="col-md-6"> 
      ...
      Years to Retirement value exceeds from Retirement Screen value</span>
	...
	<div class="col-md-6"> 
      ...
      <!-- </fieldset> -->
      <!-- <fieldset  id="dstrsbplan"> -->
      
      <div class="col-md-12" style="min-height: 160px;">   
      <div class="form-group">
	<div class="row" > 
	<div class="col-md-6  "> 
             <legend class="customFIPAStyle control-label pull-right text-right" style="color: #243665;">Disbursement Plan</legend>
             </div> 
           <div class="col-md-6 "> 
	...
	<div class="col-md-6"> 
        ...
        <div class="form-group"  >  <!-- id="disburseYrdiv" -->
      <div class="row">
	<div class="col-md-6"> 
            <label class="control-label pull-right text-right" 
             ...
             <div class="form-group " >   <!-- id="disburseAmtdiv" -->
      <div class="row">
	<div class="col-md-6"> 
              <label class="control-label  pull-right text-right" for="txtFldDlgDsbsAmt">Annual Amount
                </label>
				</div>
				<div class="col-md-6"> 
				<div class="input-group input-group-sm">
                ...
                <input type="text" 	onmouseover="fipaTooltip(this);"  name="txtFldDlgDsbsAmt"
					id="txtFldDlgDsbsAmt" class="form-control numbers fld-resp-sm applyEvntUsd" disabled="true" />
                		</div>         
				</div>	 
            </div> 
            </div>
