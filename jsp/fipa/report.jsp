						...
						<div class="col-md-9 bg-warning"
							...
							<div class="checkbox checkbox-primary bold">
								...
								<!--  To Generate all reports at one go,
								 <input	id="chkAllReport" name="chkAllReport" type="checkbox" value="Select All" onclick="reportCheckEvent(this,'rpt')" disabled="disabled">
...
<!-- 							</button> -->
			...
			<div class="row">
				<div class="col-md-12" id="analysisTypesdiv" style="font-size: 12px;width: 102%;">
					<div class="clearspace20"></div>
					
					<div class="row">
					
						<div class="col-md-2 col-md-2 col-md-2  box-line">
						    <div class="panel-heading" style="background-color: #1D655C;margin: 0px -16px 0px -16px;border-radius: 1px;">
							  <span class="custompanelHeaderTitle"><small>Cash Flow Analysis</small></span>  
						    </div>
						...
						<div class="col-md-2 col-md-2 col-md-2 box-line">
						 <div class="panel-heading" style="background-color: #1D655C;margin: 0px -16px 0px -16px;border-radius: 1px;">
							  <span class="custompanelHeaderTitle"><small>CPF Projections Analysis</small></span>  
						    </div>
							<div class="checkbox checkbox-primary">
						...
						<div class="col-md-2 col-md-2 col-md-2 box-line">
						<div class="panel-heading" style="background-color: #1D655C;margin: 0px -16px 0px -16px;border-radius: 1px;">
							  <span class="custompanelHeaderTitle"><small>Net Worth Analysis</small></span>  
						    </div>
							<div class="checkbox checkbox-primary">
			    		...
			    		<div class="col-md-2 col-md-2 col-md-2 box-line">
			    			<div class="panel-heading" style="background-color: #1D655C;margin: 0px -16px 0px -16px;border-radius: 1px;">
							  <span class="custompanelHeaderTitle"><small>Cash At Banks</small></span>  
						    </div>
							<div class="checkbox checkbox-primary">
						...
						<div class="col-md-2 col-md-2 col-md-2 box-line">
						<div class="panel-heading" style="background-color: #1D655C;margin: 0px -16px 0px -16px;border-radius: 1px;">
							  <span class="custompanelHeaderTitle"><small>Child Education</small></span>  
						    </div>
							<div class="checkbox checkbox-primary">
					...
					<div class="row">
						...
						<div class="col-md-2 col-md-2 col-md-2 box-line">
							<div class="panel-heading" style="background-color: #1D655C;margin: 0px -16px 0px -16px;border-radius: 1px;">
							  <span class="custompanelHeaderTitle"><small>Investments Details</small></span>  
						    </div>
							<div class="checkbox checkbox-primary">
						...
						<div class="col-md-2 col-md-2 col-md-2 box-line">
						   <div class="panel-heading" style="background-color: #1D655C;margin: 0px -16px 0px -16px;border-radius: 1px;">
							  <span class="custompanelHeaderTitle"><small>Insurance Policy</small></span>  
						    </div>
							<div class="checkbox checkbox-primary">
						...
						<div class="col-md-2 col-md-2 col-md-2 box-line">
						<div class="panel-heading" style="background-color: #1D655C;margin: 0px -16px 0px -16px;border-radius: 1px;">
							  <span class="custompanelHeaderTitle"><small>SNA - Self </small></span>  
						    </div>
							<div class="checkbox checkbox-primary">
						...
						<div class="col-md-2 col-md-2 col-md-2 box-line">
						<div class="panel-heading" style="background-color: #1D655C;margin: 0px -16px 0px -16px;border-radius: 1px;">
							  <span class="custompanelHeaderTitle"><small>SNA - Spouse</small></span>  
						    </div>
							<div class="checkbox checkbox-primary">
						...
						<div class="col-md-2 col-md-2 col-md-2 box-line">
							<div class="panel-heading" style="background-color: #1D655C;margin: 0px -16px 0px -16px;border-radius: 1px;">
							  <span class="custompanelHeaderTitle"><small>SRS</small></span>  
						    </div>
							<div class="checkbox checkbox-primary">
...
<div class="row">
			...
			<div class="panel-heading" style="background-color: #1D655C;margin: 0px -16px 0px -16px;border-radius: 1px;">
							  <span class="custompanelHeaderTitle"><small>RP CF Analysis</small></span>  
						    </div>
							<div class="pull-left">
						...
						<button type="button" class="btn btn-info" id="btnNetWorthPrint" style="">
			 						<span>&nbsp;Net Worth Report&nbsp;</span><i class=""></i></button>
