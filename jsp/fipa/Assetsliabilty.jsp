...
<ul id="assetLiab" class="nav nav-pills fipa_common_tab" role="tablist"	data-tabs="tabs" style="height: 30px">
	<li class="active"><a href="#assetParticulars" data-toggle="tab">
			
				<label  class="tablabel" for="AssetsTab"><i class="fa fa-money" title="Assets"></i>&nbsp;&nbsp;&nbsp;&nbsp;Assets</label>
	</a></li>
	<li><a href="#liabParticulars" data-toggle="tab">  <label  class="tablabel" for="LiabilityTab"><i class="fa fa-calculator" title="Liabilities"></i>&nbsp;&nbsp;&nbsp;&nbsp;Liabilities</label>
	</a></li>
...
<div class="tab-content">
	<div role="tabpanel" class="tab-pane fade in active" id="assetParticulars">
 ...
 <div class="container" style="margin-top: -50px">
	<div class="row">
		<ul class="breadcrumb wizard">
			...
			<li class="completed"><a href="javascript:void(0);">Asset & Liabilities</a></li>
			<li class="completed"><a href="javascript:void(0);">Asset</a></li>
			<li class="" ><a href="javascript:void(0);" id="assetliabs" style="width: 255px;display:none"></a></li>
		</ul>
	</div>
</div>
    <div class="panel-group"  role="tablist" aria-multiselectable="true">
        ...
        <div class="panel panel-default">
            <div class="panel-headingasset" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" role="tab" id="headingOne" style="color: #fff;background-color: #7f9acf;border-color: #7f9acf;font-size: 14px;padding: 13px 8px;">
            ...
            <div id="collapseOne" class="panel-collapseasset collapse" role="tabpanel" aria-labelledby="headingOne">
                <div class="panel-body">
		...
		&nbsp;&nbsp; 
			...
			<button type="button" class="btn btn-info" id="btncashOfBanksPrint" style="margin-left: 0%;" >
			 						<span>&nbsp;Cash At Bank Report&nbsp;</span><i class=""></i></button> 
		</div>
		
		<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
		&nbsp;&nbsp;
						<button type="button"  class="btn btn-info delRow-icon1"  id="CobDRow"><i class="fa fa-trash"></i><span>&nbsp;Delete</span></button>
  				 </div>
  				 <div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="CobERow"><i class="fa fa-edit"></i><span>&nbsp;Edit</span></button>
  				 </div>
				<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="CobARow"><i class="fa fa-plus"></i><span>&nbsp;Add</span></button>
  				 </div>
  ...
  <div id="COB_APD" > 
   <div id="cobMandatoryFlds"> 
			 ...
			 <tr>
							...
							<th style="width: 28px;"><div  class="checkbox checkbox-primary text-center" style="width: 28px;"><input type="checkbox" id="SelcashOfBanks" name="SelcashOfBanks" onclick="SelAllcashOfBanks(this)"><label for="SelcashOfBanks">&nbsp;</label></div></th>
							<th style="width: 192px;"><div style="width: 192px;">Description</div></th>
							<th style="width: 192px;"><div style="width: 192px;">Type of Account</div></th>
							<th style="width: 167px;"><div style="width: 167px;">Current Balance</div></th>
							<th style="width: 120px;"><div style="width: 120px;">Objective</div></th>
							<th style="width: 200px;"><div style="width: 174px;">Regular Deposit</div></th>
						</tr> 
					...
					<tr>
						...
						<div class="fld-resp-md input-group input-group-sm"> 
						 <span class="input-group-addon">
							...
							id="casstFamSavingfd" class="form-control numbers clsfipaFamily applyEvntUsd" 
						...
						<input type="text" name="casstFamRpSavingfd"
							id="casstFamRpSavingfd" class="form-control numbers applyEvntpCent clsfipaFamily"
						 />
							 <span class="input-group-addon">
					              <span class="glyphicon" id="symbolprCent"></span>
					         </span>
						...
						<td><input type="text" name="casstFamRemSavingfd"
							id="casstFamRemSavingfd" class="form-control fld-resp-md clsfipaFamily"
							maxlength="300"></input></td>
					...
					<tr align="left">
						...
						<div class="fld-resp-md input-group input-group-sm"> 
						 <span class="input-group-addon">
							...
							id="casstFamCashequ" class="form-control numbers applyEvntUsd clsfipaFamily" 
							onchange="calcSum(this,'SUMOF_CASHASST_JOIN')" ></input>
							</div>
							</td>
						...
						<input type="text" name="casstFamRpCashequ"
							id="casstFamRpCashequ" class="form-control numbers applyEvntpCent clsfipaFamily" />
							 <span class="input-group-addon">
					              <span class="glyphicon" id="symbolprCent"></span>
					         </span>
							</div>
						...
						<td><input type="text" name="casstFamRemCashequ"
							id="casstFamRemCashequ" class="form-control fld-resp-md clsfipaFamily"
							maxlength="300"></input></td>
...
<div class="modal fade" id="Cob_Dialog" style="display: none"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel"  style="z-index:1053 !important">
  <div class="modal-dialog scrollModelBodyWidth1000" role="document">
	...
	<div class="col-md-4 col-sm-6 col-xs-6 "> 
      ...
      <fieldset>
      <!-- add vignesh 0n 02 07 2021 -->
      <legend class="control-label fontboldlabel">Regular Deposit</legend>
      <div class="form-group">
	<div class="row" >
	<div class="col-md-4 col-sm-6 col-xs-6 "> 
             <!-- <label class="control-label pull-right text-right fontboldlabel" for="">Regular Deposit</label> -->
             </div> 
           <div class="col-md-6 col-sm-6 col-xs-6">  
	...
	<div class="col-md-6"> 
      ...
      <div class="modal-footer">  
        ...
        <div class="panel panel-default">
            <div class="panel-headingasset"  data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo" role="tab" id="headingTwo" style="color: #fff;background-color: #7f9acf;border-color: #7f9acf;font-size: 14px;padding: 13px 8px;">
                <h4 class="panel-title">
            ...
            <div id="collapseTwo" class="panel-collapseasset collapse" role="tabpanel" aria-labelledby="headingTwo">
                <div class="panel-body">
		...
		<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
		&nbsp;&nbsp;
						<button type="button"  class="btn btn-info delRow-icon1"  id="OtherAssetDrow"><i class="fa fa-trash"></i><span>&nbsp;Delete</span></button>
  				 </div>
  				 
				<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="OtherAssetArow"><i class="fa fa-plus"></i><span>&nbsp;Add</span></button>
  				 </div>
...
<!-- 												<td width="20%">&nbsp;</td> -->
		...
		<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
		&nbsp;&nbsp;
						<button type="button"  class="btn btn-info delRow-icon1"  id="PersDRow"><i class="fa fa-trash"></i><span>&nbsp;Delete</span></button>
  				 </div>
  				 <div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="PersERow"><i class="fa fa-edit"></i><span>&nbsp;Edit</span></button>
  				 </div>
				<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="PersARow"><i class="fa fa-plus"></i><span>&nbsp;Add</span></button>
  				 </div>
...
<!-- 			<span class="panelHeaderTitle"> Business Assets</span> <br> -->
		...
		<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
		&nbsp;&nbsp;
						<button type="button"  class="btn btn-info delRow-icon1"  id="BusiDRow"><i class="fa fa-trash"></i><span>&nbsp;Delete</span></button>
  				 </div>
  				 <div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="BusiERow"><i class="fa fa-edit"></i><span>&nbsp;Edit</span></button>
  				 </div>
				<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="BusiARow"><i class="fa fa-plus"></i><span>&nbsp;Add</span></button>
  				 </div>
...
<div class="modal fade" id="busnAssets_Dialog" style="display: none"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog scrollModelBodyWidth1000" role="document">
	...
	<div class="col-md-6 col-sm-6 col-xs-6 "> 
      ...
      <div class="modal-footer">  
        ...
        <div class="panel panel-default">
            <div class="panel-headingasset" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="true" aria-controls="collapseThree" role="tab" id="headingThree" style="color: #fff;background-color: #7f9acf;border-color: #7f9acf;font-size: 14px;padding: 13px 8px;">
                <h4 class="panel-title">
            ...
            <div id="collapseThree" class="panel-collapseasset collapse" role="tabpanel" aria-labelledby="headingThree">
                <div class="panel-body">
 ...
 <div class="pull-right" role="group" style="display: none;">
		...
		<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
		&nbsp;&nbsp;
						<button type="button"  class="btn btn-info delRow-icon1"  id="VehDRow"><i class="fa fa-trash"></i><span>&nbsp;Delete</span></button>
  				 </div>
  				 <div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="VehERow"><i class="fa fa-edit"></i><span>&nbsp;Edit</span></button>
  				 </div>
				<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="VehARow"><i class="fa fa-plus"></i><span>&nbsp;Add</span></button>
  				 </div>
	...
	<div class="col-md-12" >
				<table class="dataTable table-bordered table-striped display hover" id="fnaVehiOwnTbl" style="width:100%" >
					<thead>
						<tr>
							<th style="width:30px"> <div style="width:30px">#</div></th> 
							<!-- <th><div style="width:50px;">Select</div></th> -->
							<th style="width:50px;"><div style="width:50px;" class="checkbox checkbox-primary text-center"><input type="checkbox" id="Selvehicleownership" name="Selvehicleownership" onclick="SelAllvehicleownership(this)"><label for="Selvehicleownership" >&nbsp;</label></div></th>
							<th style="width:122px;"><div style="width:122px;">Ownership</div></th>
							<th style="width:189px;"><div style="width:189px;">Market Value</div></th>
							<th style="width:190px;"><div style="width:190px">Loan Value</div></th>
							<!-- <th><div style="width:120px">Loan Bank</div></th>
							 <th><div style="width:80px;">Period<small>(yrs)</small></div></th>  -->
							<th style="width:189px;"><div style="width:189px;">Monthly Instalment</div></th>
							<th style="width:122px;"><div style="width:122px;">Sold On Death</div></th>
							<!-- <th><div style="width:180px;">Remarks</div></th> -->
						</tr>
					</thead>
					<tbody></tbody>								
...
<div class="modal fade" id="vehown_Dialog" style="display: none"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog scrollModelBodyWidth1000" role="document">
	...
	<div role="tabpanel" class="tab-pane fade" id="liabParticulars">
			...
			<colgroup>
				...
				<tr class="fipaFldLblTextbold" >
					...
					<tr>
						...
						<td><a class="btn btn-default otherliableicon" id="otherliableicon" style='display:none'></a></td>
						<td><div class="fld-resp-md input-group input-group-sm" > 
							 <span class="input-group-addon">
								 <span class="glyphicon" id="symbolUsd"></span>
							 </span>
