...
<table>
	<tr>
		<td>
			<img src="images/AvallisLogo.png" style="max-width: 35%;margin-top: 0px;background-color: white;">
		</td>
	</tr>
</table>
</div>
			...
			<table 
				...
				<tbody>
					...
					<tr>
						...
						style="max-width: 46%; margin-top: 0px;  margin-left: 125px;">
							</td>
					</tr>
					<tr>
					 	<td>&nbsp;</td>
					...
					<tr  >
						...
						style="background: #243665;text-transform: capitalize;" onclick="submitLogin()">
						<i class="fa fa-arrow-right" onclick="hideLoader()"></i>Login</button>
	...
	<!-- <img  src="images/loading-circle.gif" id="loadit" class="hidden loading">
