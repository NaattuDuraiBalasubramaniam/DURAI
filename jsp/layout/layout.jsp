...
<head>
  ...
  <link rel="stylesheet" href="plugins/bootstrap-datepicker/css/bootstrap-datetimepicker.css?ver=2201.1">
  <link rel="stylesheet" href="plugins/bootstrap/css/bootstrap-multiselect.css?ver=2201.1">
  ...
  <link rel="stylesheet" href="plugins/bootstrap-datepicker/css/bootstrap-datepicker.min.css?ver=2201.1">
  
  <!-- Daterange picker -->
  <link rel="stylesheet" href="plugins/bootstrap-daterangepicker/css/daterangepicker.css?ver=2201.1">
  ...
  <link rel="stylesheet" type="text/css" href="plugins/fipa/css/loaderStyles.css?ver=2201.1" />
  <link rel="stylesheet" type="text/css" href="plugins/fipa/css/uielements.css?ver=2201.1">
  
  <link rel="stylesheet" type="text/css" href="plugins/jquery-qtip/jquery.qtip.css?ver=2201.1" />
  <link rel="stylesheet" type="text/css" href="plugins/jquery-qtip/toastr.min.css?ver=2201.1" />
  
   <!-- Datatable styles -->  
<link href="plugins/datatable/jquery.dataTables.min.css?ver=2201.1" rel="stylesheet">
<link href="plugins/datatable/latest/fixedColumns.dataTables.min.css?ver=2201.1" rel="stylesheet">
<link href="plugins/datatable/keyTable.dataTables.min.css?ver=2201.1" rel="stylesheet">
<link href="plugins/datatable/responsive.bootstrap.css?ver=2201.1" rel="stylesheet">
<link href="plugins/d3_charts/c3.css?ver=2201.1" rel="stylesheet">	  


<link rel='stylesheet' href='plugins/calendar/acbs_themes/themeChooser/excite.css?ver=2201.1' title="calendarThemeSet" type="text/css" />   
<link href='plugins/calendar/css/fullcalendar.css?ver=2201.1' rel='stylesheet' type="text/css" />
<link href='plugins/calendar/css/fullcalendar.print.css?ver=2201.1' rel='stylesheet' media='print' />  
<link href='plugins/calendar/css/fullcalendar.min.css?ver=2201.1' rel='stylesheet' />   
<link href='plugins/calendar/css/jquerysctipttop.css?ver=2201.1' rel='stylesheet' />   
<link href='plugins/calendar/css/floatCalendar.css?ver=2201.1' rel='stylesheet' /> 
 ...
 <link rel="stylesheet" href="plugins/fipa/css/font-awesome.min.css?ver=2201.1"> 
  <!-- htmltopdf styles -->  
   <link rel="stylesheet" type="text/css" href="plugins/fipa/css/htmlreport.css?ver=2201.1" />
  <link rel="stylesheet" type="text/css" href="plugins/fipa/css/breadcrum.css?ver=2201.1" />
...
<div class="wrapper" >
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top"  id="headerSection" Style="margin-left: 140px;background: linear-gradient(110deg, #1d655cf7 60%, #243665 60%);">
	 ...
	 <div  style="display:none" id="txtNavClientDtls">
...
<!--                   </a> -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
         ...
         <li class="mainmenu active" style="" id="main_menu_pro_scrh">
          <a href="#searchpage" id="search_li" >
            <span id="search_li_title" style="">Profile Search</span> 
       ...
       <!--  <li class="treeview mainmenu hidden">
        ...
        <li class="treeview mainmenu hidden">
          ...
          <!--   <li class="submenu"><a href="#fundflowAnnlexp"  id="dependantdets_li"><i class="fa fa-users" title="Dependent Details"></i> <span>Dependant's Info</span></a></li> -->
            ...
            <li class="submenu"><a href="#inputinvst" id="investment_li"><i class="fa fa-line-chart" title="Investments, NAV and Dividend Details"></i><span> Investments</span></a></li>
             ...
             <!-- added by John 2204.1 23032022 -->
            	
            <li class="submenu">
            	<a href="#fipaInvestments" id="fipaInv_li">
            		<i class="fa fa-line-chart" title="Investments, NAV and Dividend Details"></i>
            		<span>Investments New</span>
            	</a>
            </li>
            	
            <!-- End of Newly added Investment Menu Item -->
        ...
        <li class="mainmenu treeview hidden ctrldisabled">
          <a href="#">
  ...
  <div  id="screenTittleDiv" class="row" style="width:98%">
        <div class="col-md-6">
	        
			<span class="navHeaderTitle">
			<input type="text" name="screentittle" id="screentittle" class="txttitlastupdated" readonly="readonly" style="outline: none;"></span>
        ...
        <!--   <div class="" id="liprevious"> -->
					 <button type="button"  id="btnPrevPge" 
					 style="border-radius: 5px;background-color: #243665;margin-right:10px;display:none" class="btn BtnFIPAPREVS StylishSAVE"  onclick="fipaPreview()">
			      			 <span class="round"><i class="fa fa-caret-left"></i></span>
			      			<span class="txt">Previous</span>
			    		</button>&nbsp;&nbsp;   
					
					
					 <button type="button"  id="btnNxtPge" 
					 style="border-radius: 5px;background-color: #243665;display:none" class="btn BtnFIPASRCHNEXT StylishSAVE" onclick="fipaNext()">
    ...
    <section class="content" style="background: #eee;" id="sectncontent">
		...
		<div id="allpages"> 
			...
			<div id="fipaInvestments" class="pagecontent autosavetrigger" data-desc="INVESTMENT">
				<jsp:include page="/jsp/fipa/FIPA_Investments.jsp"></jsp:include>
			</div>
...
<input type="hidden" readonly="readonly" name="fnaId" id="fnaId" class="formHiddenIds"/>
...
<input type="hidden" name="retCPFId" id="retCPFId" class="formHiddenIds"/> 
<input type="hidden" name="retSumId" id="retSumId" class="formHiddenIds"/> 
<input type="hidden" name="careCPFId" id="careCPFId" class="formHiddenIds"/> 
<input type="hidden" name="elderCPFId" id="elderCPFId" class="formHiddenIds"/> 
<input type="hidden" name="mediCPFId" id="mediCPFId" class="formHiddenIds"/> 
<input type="hidden" name="depntProCPFId" id="depntProCPFId" class="formHiddenIds"/>
<input type="hidden" name="houseCPFId" id="houseCPFId" class="formHiddenIds"/>
<input type="hidden" name="srswithdrawId" id="srswithdrawId" class="formHiddenIds"/>
...
<input type="hidden" name="hTxtTabName" id="hTxtTabName" value="" />
    ...
    <div class="modal-content">
     <!--  <div class="modal-header"><h4>FIPA Help <i class="fa fa-info-circle"></i></h4></div> -->
      <div class="modal-body" style="background-color: #243665;color: white;"><i class="fa fa-copyright"></i> Business system developed and maintained by Avallis Financial Pte Ltd (Singapore). All rights reserved
       <h4 style="text-align-last: center;"> Ver : 2216.1</h4>
      </div>
  ...
  <div class="modal-dialog alertModelContent modal-sm" role="document">
    <div class="modal-content">
      ...
      <div id="alertmsg"  style="display: inline-block;"></div> 
       ...
       <div class="modal-footer">  
        <div class="btnStyle"><button type="button"  class="btn BtnFIPASRCH StylishSRCH" data-dismiss="modal">
					      <span class="txt">Ok</span>
					      <span class="round"><i class="fa fa-check"></i></span>
					    </button>
					    </div>
...
<!-- #######################################of RP CF Analysis Dialog Box########################################################## -->      
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-header">
        ...
        <button type="button" class="btn btn-default"  id="btnRetirementPlanningScreenPrint" ><i class="fa fa-file-pdf-o "></i><span>&nbsp;PDF&nbsp;</span></button>
         
		  <a class="btn pdf-icon hidden" id="btnRetPrint"></a>   
   ...
   <div id="rpt2"><!--  PDF print Section -->    
	  <div class="row">
		...
		&nbsp;&nbsp;
						<button type="button"  class="btn btn-info delRow-icon1"  id="RDExpDelRow"><i class="fa fa-trash"></i><span>&nbsp;Delete</span></button>
  				 </div>
  				 <div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="RDExpEditRow"><i class="fa fa-edit"></i><span>&nbsp;Edit</span></button>
  				 </div>
				<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="RDExpAddRow"><i class="fa fa-plus"></i><span>&nbsp;Add</span></button>
  				 </div>
...
<!--    start of second page added by kavi 11/07/2018-->
 	...
 	<div class="row hidden">
	  	...
	  	<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
		&nbsp;&nbsp;
						<button type="button"  class="btn btn-info delRow-icon1"  id="RDIncDisImbDelRow"><i class="fa fa-trash"></i><span>&nbsp;Delete</span></button>
  				 </div>
  				 <div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="RDIncDisImbEditRow"><i class="fa fa-edit"></i><span>&nbsp;Edit</span></button>
  				 </div>
				<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="RDIncDisImbAddRow"><i class="fa fa-plus"></i><span>&nbsp;Add</span></button>
  				 </div>
	...
	<div class="row hidden">
 	  ...
 	  <div class="row">
	  	<div class="col-md-6">
	  		<div class="text-left">		 
		 		<h4><span class="control-label" style="color:#50907C;font-weight: bold;padding:15px"> Income and funds to be received on retirement
		 		<small> ( Note: This table data is used only in report).</small></span></h4>
	  	...
	  	<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
		&nbsp;&nbsp;
						<button type="button"  class="btn btn-info delRow-icon1"  id="RDIncDelRow"><i class="fa fa-trash"></i><span>&nbsp;Delete</span></button>
  				 </div>
  				 <div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="RDIncEditRow"><i class="fa fa-edit"></i><span>&nbsp;Edit</span></button>
  				 </div>
				<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="RDIncAddRow"><i class="fa fa-plus"></i><span>&nbsp;Add</span></button>
  				 </div>
	...
	<!-- ########################Table1 Data entry######################## -->
		...
		<div class="row">
		  	...
		  	<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
		&nbsp;&nbsp;
						<button type="button"  class="btn btn-info delRow-icon1"  id="RDIncAssDelRow"><i class="fa fa-trash"></i><span>&nbsp;Delete</span></button>
  				 </div>
  				 <div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="RDIncAssEditRow"><i class="fa fa-edit"></i><span>&nbsp;Edit</span></button>
  				 </div>
				<div class="btn-group pull-right funcToDisable" role="group" style="display: block;">
				&nbsp;&nbsp;
						<button type="button"  class="btn btn-info addRow-icon1"   id="RDIncAssAddRow"><i class="fa fa-plus"></i><span>&nbsp;Add</span></button>
  				 </div>
	  		</div>
		</div>
...
<div id="projInvRettbldiv" >
		<div class="row">
		   ...
		   <div class="form-group" id="rpt5" style="margin-left: 0%;">  
		   <div class="clearspace20"></div>
			<div class="row">
   ...
   <div class="tab-content">
      ...
      <button type="button" class="btn btn-info"  id="btnAccumlationBasedPrint"  style="margin-left: 90%;margin-top: -5%;"">
		<span>&nbsp;PDF&nbsp;</span><i class=""></i></button> 
      <div class="row">
        	<div class="col-md-6">
	...
	<div class="col-md-6 col-sm-6 col-xs-6 ">  
           ...
           <div class="col-md-6 col-sm-6 col-xs-6"> 
            ...
            <select class="form-control fld-resp-sm" id="txtFldDlgIncAssClsfy" name="txtFldDlgIncAssClsfy" style="width:202px;">
							...
							<option value="CPF Retirement Sum Scheme">CPF Retirement Sum Scheme</option>
...
<!-- jQuery 3 -->
<script src="plugins/jquery/jquery-1.12.4.js?ver=2201.1"></script>
<!-- jQuery UI v1.12.1-->
...
<script src="plugins/bootstrap/js/bootstrap-multiselect.js?ver=2201.1"></script>
<script src="plugins/bootstrap/js/bootstrap3-typeahead.js?ver=2201.1"></script>

<!-- daterangepicker -->
<script src="plugins/moment/moment.min.js?ver=2201.1"></script>
<script src="plugins/bootstrap-daterangepicker/daterangepicker.js?ver=2201.1"></script>


<!-- datepicker -->
<script src="plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js?ver=2201.1"></script>
<script src="plugins/bootstrap-datepicker/js/bootstrap-datetimepicker.js?ver=2201.1"></script>
<!-- Bootstrap WYSIHTML5 -->
...
<script src="plugins/color_picker/iro.js?ver=2201.1"></script>
<script src="plugins/color_picker/colorpicker.js?ver=2201.1"></script>

<script src="plugins/fipa/js/dialog_jquery.js?ver=2201.1"></script> 
<script src="plugins/fipa/js/fipa.mandatories.js?ver=2201.1"></script>

<script src="plugins/jquery-qtip/jquery.qtip.js?ver=2201.1"></script>
<script src="plugins/jquery-qtip/toastr.min.js?ver=2201.1"></script>

<!-- Datatable plugins --> 
<script src="plugins/datatable/jquery.dataTables.min.js?ver=2201.1"></script>  

<script src="plugins/datatable/latest/dataTables.fixedColumns.min.js?ver=2201.1"></script>
<!-- <script src="plugins/datatable/latest/dataTables.fixedColumns.min.js"></script> -->
<script src="plugins/datatable/dataTables.keyTable.min.js?ver=2201.1"></script>
<script src="plugins/datatable/dataTables.select.min.js?ver=2201.1"></script>
<script src="plugins/datatable/dataTables.responsive.js?ver=2201.1"></script>

 <script src="plugins/d3_charts/d3.v5.js?ver=2201.1"></script> 
 <script src="plugins/d3_charts/c3.js?ver=2201.1"></script> 
 <script src="plugins/d3_charts/d3script.js?ver=2201.1"></script>   


	<script src="plugins/fipa/js/fipa.multiselect.js?ver=2201.1"></script>
	<script src="plugins/fipa/js/fipa.datatables.js?ver=2201.1"></script>

	<script src="plugins/fipa/js/datepicker.js?ver=2201.1"></script>


	<script src="plugins/fipa/js/fipa.common.js?ver=2201.1"></script>
	<script src="plugins/fipa/js/fipa.constants.js?ver=2201.1"></script>
	<script src="plugins/fipa/js/fipa.client.js?ver=2201.1"></script>
	<script src="plugins/fipa/js/fipa.dependant_new.js?ver=2201.1"></script>
	<script src="plugins/fipa/js/fipa.dependant.js?ver=2201.1"></script>
	<script src="plugins/fipa/js/fipa.savinginvestment.js?ver=2201.1"></script>
	 <script src="plugins/fipa/js/fipa.childparticulars.js?ver=2201.1"></script>
	<script src="plugins/fipa/js/fipa.childparticular_new.js?ver=2201.1"></script>
	<script src="plugins/fipa/js/fipa.fingoals.js?ver=2201.1"></script>  
	<script src="plugins/fipa/js/fipa.healthins.js?ver=2201.1"></script> 
	<script src="plugins/fipa/js/fipa.propownership.js?ver=2201.1"></script>
	<script src="plugins/fipa/js/fipa.vehownership.js?ver=2201.1"></script>	 
	<!-- <script src="plugins/fipa/js/fipa.advicerecom.js"></script>	 -->
	<script src="plugins/fipa/js/fipa.assets.js?ver=2201.1"></script>
	<script src="plugins/fipa/js/fipa.areaofconcrn.js?ver=2201.1"></script>
	<script src="plugins/fipa/js/fipa.reasons.js?ver=2201.1"></script>	   
	<script src="plugins/fipa/js/genReport.js?ver=2201.1"></script>
	<script src="plugins/fipa/js/cpfdetails.js?ver=2201.1"></script>
	<script src="plugins/fipa/js/fipa.retirement.js?ver=2201.1"></script>
	<script src="plugins/fipa/js/retCpfPayout.js?ver=2201.1"></script>
	<script src="plugins/fipa/js/fipa.cashofbanks.js?ver=2201.1"></script>   
	<script src="plugins/fipa/js/fipa.srs.js?ver=2201.1"></script>  
	<script src="plugins/fipa/js/fipa.lifeins.js?ver=2201.1"></script>	
	<script src="plugins/fipa/js/fipa.newlife.js?ver=2201.1"></script> 
	<script src="plugins/fipa/js/fipa.lifeInsurance.js?ver=2201.1"></script>   
	<script src="plugins/fipa/js/fipa.investment.js?ver=2201.1"></script>    
	<script src="plugins/fipa/js/fipa.investment_new.js?ver=2201.1"></script>  <!-- added by John 2204.1 23032022 for FIPA Investments -->  
	<script src="plugins/fipa/js/retEducationplg.js?ver=2201.1"></script>	
	<script src="plugins/fipa/js/fipa.attachment.js?ver=2201.1"></script>
	<script src="plugins/fipa/js/master.property.js?ver=2201.1"></script>  
	<script src="plugins/fipa/js/autoalter.js?ver=2201.1"></script>  
	<script src="plugins/fipa/js/fipa.fpmsclient.js?ver=2201.1"></script>   
	 
	 <!-- Retirement Cash Flow Projection -->
	<script src="plugins/fipa/js/rdcflw.ctCost.js?ver=2201.1" ></script> 
	<script src="plugins/fipa/js/rdcflw.inpIncme.js?ver=2201.1" ></script> 
	<script src="plugins/fipa/js/rdcflw.projOfInc.js?ver=2201.1" ></script> 
	<script src="plugins/fipa/js/rdcflw.anlysRtCsflw.js?ver=2201.1" ></script> 
	
	
	<script src='plugins/calendar/js/moment.min.js?ver=2201.1'></script>
	<script src='plugins/calendar/js/moment.js?ver=2201.1'></script>	
	<script src='plugins/calendar/js/fullcalendar.min.js?ver=2201.1'></script>   
	<script src='plugins/calendar/js/gcal.js?ver=2201.1'></script>   
	<script src='plugins/calendar/js/jquery-dateformat.js?ver=2201.1'></script> 
	<script src='plugins/calendar/js/fipa.calendar.js?ver=2201.1'></script> 
...
<c:if test="${not empty FIPA_TABVARIABLE}">
		<script type="text/javascript">
			FIPATab = "<%=request.getAttribute("FIPA_TABVARIABLE")%>";
		</script>
	</c:if>
<script type="text/javascript">
...
$(document).on('click', '.option-btn', function () {
 ...
 $(document).ready(function () {
		...
		$('.fipa_common_tab li a').on("click",function(){
            $("#hTxtTabName").val($(this).attr("href")); 
       })
    	...
    	$('.sidebar-menu li a').click(function (event) {
			...
			else if($("#hTxtMenuName").val() == "#fipaInvestments"){
				$("#screentittle").val("Investments New");
				$('#btnPrevPge').show();  
				$('#btnNxtPge').show();
				$("#liprevious").removeClass("fipaAttPreviousBtnstyle");
			}
