	...
	<div class="row vertical-center-row">
		<div class="panel panel-standard">
			...
			<div class="panel-body" style="text-align: center;">
				<h1>Form Resubmission is turned-off</h1>
				<h2>Please Close and try again.</h2>
				<br /> <br />
			</div>
			<div class="panel-footer panel-footer-standard"
				style="text-align: center;background-color: #243665;border-color: #243665;">
<!-- 			<button class="btn btn-default" role="button" value=" Login " title="Logout" id="btnReLogin" onclick="relogin()"> -->
<!-- 						Login Again -->
<!-- 					</button> -->
