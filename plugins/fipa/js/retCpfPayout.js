...
var cell2 ='<input type="text" name="txtFldCpfLifeAge" class="form-control editable form-tablecolor"  onmouseover="fipaTooltip(this);" />';

var cell3 ='<select name="txtFldCpfLifeTypes" class="form-control editable form-tablecolor"  onmouseover="fipaTooltip(this);"></select>';

var cell4 ='<input type="text" name="txtFldCpfLifePrem" class="form-control editable form-tablecolor"  onmouseover="fipaTooltip(this);" disabled="true"/>';

var cell5 ='<input type="text" name="txtFldCpfLifePayoutInc" class="form-control editable form-tablecolor"  onmouseover="fipaTooltip(this);" disabled="true" />';

var cell6 ='<input type="text" name="txtFldCpfLifeFdTrans" class="form-control editable form-tablecolor"  onmouseover="fipaTooltip(this);" disabled="true"/>';
