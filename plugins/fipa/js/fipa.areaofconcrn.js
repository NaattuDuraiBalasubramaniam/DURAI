...
var cell2 ='<input type="text" name="txtFldOthAreaConcern" class="form-control editable form-tablecolor"  onmouseover="fipaTooltip(this);" maxlength="500"/>'+
