// /**
// * Life Insurance Dialog  - BR-Plan Details
// */  
//
//
//
...
//	
//	var cell12 = '<input type="text" name="txtFldliplnRemarks" class="form-control editable"   maxlength="300"   onmouseover="fipaTooltip(this);"   />'+
//	'<input type="hidden" name="txtFldliplnCrtdBy"/><input type="hidden" name="txtFldliplnCrtdDate"/>'
//	+'<input type="hidden" name="bplfretYrstoret" value="'+$("#retYrstoret").val()+'"/>'
//	+'<input type="hidden" name="bpretSelfretage" value="'+$("#retSelfCoordinateage").val()+'"/>'
//	+'<input type="hidden" name="bpretSpouseretage" value="'+$("#retSpsCoordinateage").val()+'"/>'
//	+'<input type="hidden" name="bpretMultionret"  />'
//	+'<input type="hidden" name="bpretCashvalonret"  />'
//	+'<input type="hidden" name="bpretIntrateused" value="'+$("#caSavingDeprate").val()+'"/>'
//	+'<input type="hidden" name="bpretPrcnttoused" />'
//	+'<input type="hidden" name="bpcashvalRetAge" />'
//	+'<input type="hidden" name="bpcashvalRefId" />';
//
//
//	 
//
...
function addDynPlanName(){
	 ...
	 var $liRaiderDettblcount = liRaiderDetailstbl.rows().count(); 
		  ...
		  var temp = $("#lipPlanname").val();
		  
	 $("#lipPlanname option").remove(0);
	 $('#lipPlanname').append( '<option value="">--SELECT--</option>' );
