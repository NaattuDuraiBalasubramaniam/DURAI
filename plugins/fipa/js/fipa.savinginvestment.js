...
var cell2 = '<input type="text" name="txtFldSAPurpose" class="form-control editable form-tablecolor" onmouseover="fipaTooltip(this);" maxlength="300"/>'; 
var cell3 = '<input type="text" name="txtFldSAWhen" class="form-control editable form-tablecolor" onmouseover="fipaTooltip(this);" style="width:60px"/>';
var cell4 = '<input type="text" name="txtFldSAmount" class="form-control editable form-tablecolor" onmouseover="fipaTooltip(this);" />';
var cell5 = '<select name="selSAPriority" id="selSAPriority" class="form-control editable form-tablecolor" onmouseover="fipaTooltip(this);"> </select>';
var cell6 = '<select name="selSARiskLvl" id="selSARiskLvl" class="form-control editable form-tablecolor" onmouseover="fipaTooltip(this);"   > </select>'+
