...
function typeOfCoveragePro(ElmVals,opt){ 
	...
	if(ElmVals=="All"){
		if(opt == 'block'){
		$('#divmulTPD,#divmaaTPD,#divexpTPD,#divdisTPD,#divdisPayoutTPD,#divmaxPayoutTPD,#divmulTPDDiv').show();
		$('#divmulBootDeath,#divmaaDeath,#divexpDeath,#divyrPayDeath,#divmulBootDeathDiv').show();
		$('#divdisBenefit,#divdisPayout,#divmaxPayout,#divdisBenefitDiv,#divLongTermdisBenefit,#divmaxPayout,#divlongdisPayout,#divdisminnoofADL,#divLongTermdisBenefitDiv').show();
		$('#divmulCriIllErly,#divmaaCriIllErly,#divexpCriIllErly,#divyrPayCriIllErly,#divmulCriIllErlyDiv').show();
		$('#divmulCriIllAdv,#divmaaCriIllAdv,#divexpCriIllAdv,#divdisCriIllAdv,#divdisPayoutCriIllAdv,#divmaxPayoutCriIllAdv,#divmulCriIllAdvDiv').show();
		$('#divdesHSBenefit,#divinsHSBenefit,#divdedHSBenefit,#divtypHSBenefit,#divyrPayHSP,#divexpHSP,#divmaaHSP,#divmulHSP,#divmulHSPDiv').show();
		$('#divmulPA,#divmaaPA,#divexpPA,#divyrPayPA,#divmulPADiv').show();
		$('#divremarks1,#divremarks2,#divremarks3,#divremarks4,#divremarks5,#divremarks6,#divremarks7,#divremarks13').show();
		$('#btnForRetirementClone,#btnForRetirementCloneDiv').show();
		$('#btnForEducationClone,#btnForEducationCloneDiv').show();
	...
	if(ElmVals=="TPD"){
		if(opt == 'none'){
			$('#divmulTPD,#divmaaTPD,#divexpTPD,#divdisTPD,#divdisPayoutTPD,#divmaxPayoutTPD,#divremarks3,#divremarks3,#divmulTPDDiv').hide();
		}
		else{
			$('#divmulTPD,#divmaaTPD,#divexpTPD,#divdisTPD,#divdisPayoutTPD,#divmaxPayoutTPD,#divremarks3,#divremarks3,#divmulTPDDiv').show();
		}
		
 	} 
	if(ElmVals=="DB"){
		if(opt == 'none'){
			$('#divmulBootDeath,#divmaaDeath,#divexpDeath,#divyrPayDeath,#divremarks1,#divmulBootDeathDiv').hide();
		}
		else{
			$('#divmulBootDeath,#divmaaDeath,#divexpDeath,#divyrPayDeath,#divremarks1,#divmulBootDeathDiv').show();
		}
	...
	if(ElmVals=="DIS"){ 
		if(opt == 'none'){
			$('#divdisBenefit,#divdisPayout,#divmaxPayout,#divremarks2,#divdisBenefitDiv').hide();
			
		}
		else{
			$('#divdisBenefit,#divdisPayout,#divmaxPayout,#divremarks2,#divdisBenefitDiv').show();
	...
	if(ElmVals=="LTDIS"){ 
		if(opt == 'none'){
			$('#divLongTermdisBenefit,#divmaxPayoutADL,#divlongdisPayout,#divdisminnoofADL,#divremarks13,#divLongTermdisBenefitDiv').hide();
		}
		else{
			$('#divLongTermdisBenefit,#divmaxPayoutADL,#divlongdisPayout,#divdisminnoofADL,#divremarks13,#divLongTermdisBenefitDiv').show();
		}
	...
	if(ElmVals=="CIE"){
		if(opt == 'none'){
			$('#divmulCriIllErly,#divmaaCriIllErly,#divexpCriIllErly,#divyrPayCriIllErly,#divremarks5,#divmulCriIllErlyDiv').hide();
		}
		else{
			$('#divmulCriIllErly,#divmaaCriIllErly,#divexpCriIllErly,#divyrPayCriIllErly,#divremarks5,#divmulCriIllErlyDiv').show();
		}
		
 	} 
	if(ElmVals=="CIA"){
		if(opt == 'none'){
			$('#divmulCriIllAdv,#divmaaCriIllAdv,#divexpCriIllAdv,#divdisCriIllAdv,#divdisPayoutCriIllAdv,#divmaxPayoutCriIllAdv,#divremarks4,#divmulCriIllAdvDiv').hide();
		}
		else{
			$('#divmulCriIllAdv,#divmaaCriIllAdv,#divexpCriIllAdv,#divdisCriIllAdv,#divdisPayoutCriIllAdv,#divmaxPayoutCriIllAdv,#divremarks4,#divmulCriIllAdvDiv').show();
		}
		
 	} 
	if(ElmVals=="HP"){
		if(opt == 'none'){
			$('#divdesHSBenefit,#divinsHSBenefit,#divdedHSBenefit,#divtypHSBenefit,#divyrPayHSP,#divexpHSP,#divmaaHSP,#divmulHSP,#divremarks7,#divmulHSPDiv').hide();
		}
		else{
			$('#divdesHSBenefit,#divinsHSBenefit,#divdedHSBenefit,#divtypHSBenefit,#divyrPayHSP,#divexpHSP,#divmaaHSP,#divmulHSP,#divremarks7,#divmulHSPDiv').show();
		}
		
 	}
	if(ElmVals=="PA"){  
		if(opt == 'none'){
			$('#divmulPA,#divmaaPA,#divexpPA,#divyrPayPA,#divremarks6,#divmulPADiv').hide();
		}
		else{
			$('#divmulPA,#divmaaPA,#divexpPA,#divyrPayPA,#divremarks6,#divmulPADiv').show();
		}
