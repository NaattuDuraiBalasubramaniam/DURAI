...
var cell2 = '<select  name="selFinGoalType" class="form-control editable form-tablecolor"  onmouseover="fipaTooltip(this);"></select>'; 
var cell3 = '<input type="text" name="txtFldFinGoal" class="form-control editable form-tablecolor"   onmouseover="fipaTooltip(this);" maxlength="300"/>';
 
var cell4 ='<select name="selFinGoalPrio" class="form-control editable form-tablecolor" ></select>'+
