...
//console.log("console.log data2 " + data2);
...
//    var data1 = annlincomexpALL.map(function (e) {
  //      return e.AnnualIncome;
   // });
    ...
    var positivenegativecolours = data1.map((value) => value < 0 ? 'maroon' : 'green');
    //Line chart
    ...
    cashfloeProjectionOnRetirementchartTypeED = document.getElementById("cashfloeProjectionOnRetirementchartTypeED").value;
         ...
         if (cashfloeProjectionOnRetirementchartTypeED == "Bar") {
            var fund1data = {
                ...
                backgroundColor: positivenegativecolours,
                hoverBackgroundColor: positivenegativecolours,
            ...
            config = {
                ...
                data: {
                    ...
                    datasets: [
                    {
                        ...
                        backgroundColor: positivenegativecolours,
                        borderColor: positivenegativecolours,
