...
/*$(document).on('click',"input[name=txtFldDepnDob]",function(){
	$(".dates").trigger('click');
	$(this).datetimepicker(dobOptions); 
});*/

/*$lastRow.find("td").find(".dates").click(function(){
$(this).datetimepicker(dobOptions);
});*/
...
$("#btnFamilyMembersPrint").click(function (){ 
	
	var rl = $('#deptParticularsTableNew tbody tr:visible').length;
	if(rl == 0) {
	...
	var fileSave ="Dependant_Particular_";
	
	var tblIddeptParticularsTable ="deptParticularsTableNewdiv";  //table id 
	var tblIddeptParticularsTablefooter ="deptParticularsTablefooterNew";
	var pdfTitle ="Other than immediate Family Members"; // $(".cpfAccounttitle").text(); // table title name
	 
	var screentittlefootername = "Dependant's Info";

	/*var deptcalctablerarray =[" ","Self","Spouse","Total"];
	
	var coldeptcalctablerarray =[]; 
	coldeptcalctablerarray.push(deptcalctablerarray);*/

	
	var deptParticularsTableheaderarray  = [
	    [
	        {content: '', colSpan:7, styles: {halign: 'center'}}, 
	        {content: 'Monthly Amount($)', colSpan: 3, styles: {halign: 'center'}}
	        
	    ],
	    ["#","Dependant Name","Relationship","DOB","Age (yrs)","Gender","Years to Support (yrs)","By Self($)","By Spouse($)","Total Contribution($)"],
	];
	
	var jsonObject = 
	    [{"key":"Image","value":tblIddeptParticularsTable,"Title":pdfTitle,"TitleFooter":screentittlefootername,"header":"","pdfaddnewPage":""},
	     {"key":"Table","value":tblIddeptParticularsTablefooter,"Title":pdfTitle,"TitleFooter":screentittlefootername,"header":"","pdfaddnewPage":"yes"}
       ];
...
$("#btnChildParticularsPrint").click(function (){ 
	 
	
	var rl = $('#childParticularsTableNew tbody tr:visible').length;
	if(rl == 0) {
		alert("No data to export")
		return false;
	}
	 
	var childparticularsdivId = 'childParticularsTableNewdiv';
	var pl ="portrait";  // landscape     portrait
	var fileSave ="Children_Particulars_";
	
	 
	var childscreentittle =""; //Children Particulars
	var screentittlefootername = "Children Particular";
