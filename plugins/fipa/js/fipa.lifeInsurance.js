...
//	var disimburse = $("#retMultionret").val();
	var disimburse = $("#plancoveragetbl tbody tr").find("td").find('select[name="retMultionret"]').val();
	if(disimburse == "Y"){ 
		...
		if(isEmpty($("#plancoveragetbl tbody tr").find("td").find('input[name="retPrcnttoused"]').val())){
			showAlert("Key in % to be used for Retirement", $("#plancoveragetbl tbody tr").find("td").find('input[name="retPrcnttoused"]')); 
			return;
		}
		retplgClearFlds();
...
//		$("#liRetirementPlg_Dialog").find("input[id=txtFldDlgRetPlgMode]").val("I");//instant save added line
		...
		loadAgeStartEnd($("#liRetirementPlg_Dialog #txtFldDlgRetPlgCommOfAge"),$("#retAgeBasedon"));
...
//			$("#liRetirementPlg_Dialog").find(".modal-footer").find("button:eq(0)").text("Add");
		...
		if(isEmpty(disimburse)){
			showAlert("Select the multiple disbursment of income", $("#plancoveragetbl tbody tr").find("td").find('select[name="retMultionret"]')); 
		}else{
			
			showAlert("Since the multiple disbursment of income is No",null); 
...
var $lastRow =$("#liRetirementPlgtbl ").find("tr").last();
...
$lastRow.find("td:eq(5)").find('input:eq(0)').val($("#liRetirementPlg_Dialog #txtFldDlgRetPlgCommOfAge").val()); 
...
$lastRow.find("td:eq(6)").find('input:eq(0)').val($("#liRetirementPlg_Dialog #txtFldDlgRetPlgEndOfAge").val());
...
$lastRow.find("td:eq(7)").find('input:eq(0)').val($("#liRetirementPlg_Dialog #txtFldDlgRetPlgEscaltAge").val());
...
$lastRow.find("td:eq(8)").find('input:eq(0)').val($("#liRetirementPlg_Dialog #txtFldDlgRetPlgGTDIncome").val());
...
$lastRow.find("td:eq(9)").find('input:eq(0)').val($("#liRetirementPlg_Dialog #txtFldDlgRetPlgNonGTDIncome").val());
...
$lastRow.find("td:eq(10)").find('input:eq(0)').val(Number($("#liRetirementPlg_Dialog #txtFldDlgRetPlgTotalIncome").val()));
...
$lastRow.find("td:eq(11)").find('input:eq(0)').val($("#liRetirementPlg_Dialog #txtFldDlgRetPlgAssBankIntRate").val());
...
$lastRow.find("td:eq(12)").find('input:eq(0)').val($("#liRetirementPlg_Dialog #selDlgRetPlgRemarks").val());
...
if(dataset != null){
	...
	for(var data in dataset){
		...
		switch(data){
			...
			//	$lastRow.find("td:eq(2)").find('input[id=txtFldMvretPlanName]').val(col); 
				break;
...
function lfRetPlgVRow(){
	...
	var $lastRow =$("#liRetirementPlgtbl").find("tr:visible").last();
	if($rowCount<1){
	...
	$("#liRetirementPlgtbl tbody tr:visible").find('input[name="radretplgSelect"]').each(function(){ //Checkbox selection
		...
		if($curElm.is(":checked")){ 
			...
			var $mode = $curElm.parents("tr").find("td:first").find('input[name="txtFldretplgMode"]').val(); 
			...
			if(($mode == INS_MODE) || ($mode == UPD_MODE) ){
				...
				// $curElm.parents("tr").find("td:first").find('input:eq(0)').val($mode);  
			    	$curElm.parents("tr").find("td:first").find('input[name="txtFldretplgMode"]').val($mode);
...
//					     		NRRetPlgTbl($row);//life to ret sync
			...
			if(($mode == QRY_MODE)){
				 ...
				 $curElm.parents("tr").find("td:first").find('input[name="txtFldretplgMode"]').val(UPD_MODE);
				 $(this).parents("tr").find("td").find("input.editable,select.editable").each(function(){
						$(this).attr("disabled",false); 
						$row.removeClass('selected');  
						$(this).parent().css({border:'1px solid green'});
...
$('#liRetirementPlgtbl  tbody').find('input[type=checkbox]').each(function(){
		if($(this).is(":checked")){
			  
			var row = $(this).closest("tr");  
			var  mode  = row.find("td:eq(0)").find("input[name=txtFldretplgMode]").val(); 
			var refId =  $(this).parents("tr").find("td:first").find('input[name=txtFldLifeMvRetId]');
...
//						 console.log($(this).index());
					//	var row = $(this).parents("tr");          
						...
						var mode = $(this).parents("tr").find("td:first").find('input[name=txtFldretplgMode]').val(); 
...
$("#liRetirementPlg_Dialog #txtFldDlgRetPlgCommOfAge,#liRetirementPlg_Dialog #txtFldDlgRetPlgEndOfAge,#txtFldDlgRetPlgEscaltAge").on("change",function(){
	if(!isEmpty($(this).val())){
...
$("#liRetirementPlg_Dialog #txtFldDlgRetPlgCommOfAge").on("change",function(){
//	loadAgeEnd($(this),$("#txtFldDlgRetPlgEndOfAge"));
	if(!rdStartAgeValidate($('#liRetirementPlg_Dialog #txtFldDlgRetPlgCommOfAge'),$('#lipOwner')))return;
});
$("#liRetirementPlg_Dialog #txtFldDlgRetPlgEndOfAge").on("change",function(){
	if(!rdEndAgeValidate($('#liRetirementPlg_Dialog #txtFldDlgRetPlgCommOfAge'),$(this)))return;
});
...
//	  $('#liRetirementPlg_Dialog #txtFldDlgRetPlgMode').val($lastRow.find("td:eq(0)").find('input:eq(0)').val());//instant save added line
	//  $('#liRetirementPlg_Dialog #txtFldDlgRetPlgRefId').val($lastRow.find("td:eq(0)").find('input:eq(2)').val());
	  $('#liRetirementPlg_Dialog #txtFldDlgRetPlgId').val($lastRow.find("td:eq(0)").find("input[name=txtFldLifeMvRetId]").val());
	  $('#liRetirementPlg_Dialog #txtFldDlgRetPlgPlanName').val($lastRow.find("td:eq(2)").find("input[name=txtFldMvretPlanName]").val());
	  $('#liRetirementPlg_Dialog #txtFldDlgRetPlgIncepDate').val($lastRow.find("td:eq(3)").find("input[name=txtFldMvretIncDate]").val());
	  $('#liRetirementPlg_Dialog #txtFldDlgRetPlgExpDate').val($lastRow.find("td:eq(4)").find("input[name=txtFldMvretExpDate]").val());
//	  loadAgeStartEnd($("#txtFldDlgRetPlgCommOfAge"),$("#retAgeBasedon"));
	  $('#liRetirementPlg_Dialog #txtFldDlgRetPlgCommOfAge').val($lastRow.find("td:eq(5)").find("input[name=txtFldCommenceAge]").val());
	  $('#liRetirementPlg_Dialog #txtFldDlgRetPlgEndOfAge').val($lastRow.find("td:eq(6)").find("input[name=txtFldEndAge]").val());
	  $('#liRetirementPlg_Dialog #txtFldDlgRetPlgEscaltAge').val($lastRow.find("td:eq(7)").find("input[name=txtFldEsclationRate]").val());
	  $('#liRetirementPlg_Dialog #txtFldDlgRetPlgGTDIncome').val($lastRow.find("td:eq(8)").find("input[name=txtFldGtdIncome]").val());
	  $('#liRetirementPlg_Dialog #txtFldDlgRetPlgNonGTDIncome').val($lastRow.find("td:eq(9)").find("input[name=txtFldNonGtdIncome]").val());
	  $('#liRetirementPlg_Dialog #txtFldDlgRetPlgTotalIncome').val($lastRow.find("td:eq(10)").find("input[name=txtFldTotalIncome]").val());
...
//	  $('#liRetirementPlg_Dialog #txtFldDlgRetPlgPVFValAtRetRate').val($lastRow.find("td:eq(9)").find('input:eq(0)').val());
	  $('#liRetirementPlg_Dialog #txtFldDlgRetPlgAssBankIntRate').val($lastRow.find("td:eq(11)").find("input[name=txtFldAssumedBankInt]").val());
	  $('#liRetirementPlg_Dialog #txtFldDlgRetPlgCrtdBy').val($lastRow.find("td:eq(11)").find("input[name=txtFldMvRetCrtdBy]").val()); 
	  $('#liRetirementPlg_Dialog #txtFldDlgRetPlgCrtdDate').val($lastRow.find("td:eq(11)").find("input[name=txtFldMvRetCrtdDate]").val()); 
	  $('#liRetirementPlg_Dialog #selDlgRetPlgRemarks').val($lastRow.find("td:eq(12)").find("input[name=txtFldMvRemarks]").val()); 
...
function retplgfilldomval($RowId,$row){
	//alert("Edit");
	//alert( $("#liRetirementPlg_Dialog #txtFldDlgRetPlgPlanName").val());
	$row.find("td:eq(2)").find("input[name=txtFldMvretPlanName]").val($("#liRetirementPlg_Dialog #txtFldDlgRetPlgPlanName").val()); 
	$row.find("td:eq(3)").find("input[name=txtFldMvretIncDate]").val($("#liRetirementPlg_Dialog #txtFldDlgRetPlgIncepDate").val());
	$row.find("td:eq(4)").find("input[name=txtFldMvretExpDate]").val($("#liRetirementPlg_Dialog #txtFldDlgRetPlgExpDate").val());  
	
	$row.find("td:eq(5)").find("input[name=txtFldCommenceAge]").val($("#liRetirementPlg_Dialog #txtFldDlgRetPlgCommOfAge").val()); 
	$row.find("td:eq(6)").find("input[name=txtFldEndAge]").val($("#liRetirementPlg_Dialog #txtFldDlgRetPlgEndOfAge").val());
	$row.find("td:eq(7)").find("input[name=txtFldEsclationRate]").val($("#liRetirementPlg_Dialog #txtFldDlgRetPlgEscaltAge").val());  
	$row.find("td:eq(8)").find("input[name=txtFldGtdIncome]").val($("#liRetirementPlg_Dialog #txtFldDlgRetPlgGTDIncome").val()); 
	$row.find("td:eq(9)").find("input[name=txtFldNonGtdIncome]").val($("#liRetirementPlg_Dialog#txtFldDlgRetPlgNonGTDIncome").val()); 
	$row.find("td:eq(10)").find("input[name=txtFldTotalIncome]").val($("#liRetirementPlg_Dialog #txtFldDlgRetPlgTotalIncome").val());
...
//	$row.find("td:eq(9)").find('input:eq(0)').val($("#txtFldDlgRetPlgPVFValAtRetRate").val());   
	$row.find("td:eq(11)").find("input[name=txtFldAssumedBankInt]").val($("#liRetirementPlg_Dialog #txtFldDlgRetPlgAssBankIntRate").val()); 
	$row.find("td:eq(12)").find("input[name=txtFldMvRemarks]").val($("#liRetirementPlg_Dialog #selDlgRetPlgRemarks").val());  
//	$row.find("input[type=text]").prop("readonly",true);//instant save added line
//	$row.find("select").prop("disabled",true);//instant save added line
...
//	 $( document ).ready(function() {
		 $("#liRetirementPlgtbl thead tr").each(function(colindex){ 
				$("#retirementtabhead1").css({'display' : ''}) ;
				$("#retirementtabhead2").css({'display' : ''}) ;
				$("#retirementtabhead3").css({'display' : ''}) ; 
				$("#retirementtabhead4").css({'display' : ''}) ;
				$("#retirementtabhead5").css({'display' : ''}) ;
				$("#retirementtabhead6").css({'display' : ''}) ;
				$("#retirementtabhead7").css({'display' : ''}) ;
				$("#retirementtabhead8").css({'display' : ''}) ;
				$("#retirementtabhead9").css({'display' : ''}) ;
				$("#retirementtabhead10").css({'display' : ''}) ;
				$("#retirementtabhead11").css({'display' : ''}) ;
				$("#retirementtabhead12").css({'display' : ''}) ;
				$("#retirementtabhead13").css({'display' : ''}) ;
				
		});
		 $("#liRetirementPlgtbl tbody tr td").css({'display' : ''});
		 
		 
		 
		// $("#liEduPayoutstbl").css({'width' : '1269px'}) ;
		 
		 $("#liEduPayoutstbl thead tr").each(function(colindex){ 
			 
			    $("#tabhead1").css({'display' : ''}) ;
				$("#tabhead2").css({'display' : ''}) ;
				$("#tabhead3").css({'display' : ''}) ;
				$("#tabhead4").css({'display' : ''}) ;
				$("#tabhead5").css({'display' : ''}) ;
				
		 });
		 
		 $("#liEduPayoutstbl tbody tr td").css({'display' : ''});
		  
		 $("#liEduPayoutstbl tfoot tr").each(function(colindex){ 
			 
//			    $("#pvEdAgeCalTablefooterid1").css({'width' : '972px'}) ;
//				$("#pvEdAgeCalTablefooterid2").css({'width' : '274px'}) ;
				
		 });
		 $("#pvEdAgeCalTablefooter #txtFldTotalPVCal").val("");
...
$("#liRetirementPlg_Dialog #txtFldDlgRetPlgCommOfAge").on("change",function(){
//	loadAgeStartEnd($("#txtFldDlgRetPlgCommOfAge"),$("#retAgeBasedon"));
	StartAgeValidate($(this),$("#liRetirementPlg_Dialog #txtFldDlgRetPlgEndOfAge"));
});


$("#liRetirementPlg_Dialog #txtFldDlgRetPlgEndOfAge").on("change",function(){
	EndAgeValidate($(this),$("#liRetirementPlg_Dialog #txtFldDlgRetPlgCommOfAge"));
});
/**/
...
$("#liRetirementPlg_Dialog #txtFldDlgRetPlgCommOfAge").on("change",function(){
	...
	var array=[];
	var selfCommAge=isEmpty($("#liRetirementPlg_Dialog #txtFldDlgRetPlgCommOfAge").val()) ? "" : Number($("#liRetirementPlg_Dialog #txtFldDlgRetPlgCommOfAge").val());		
	...
	$("#liRetirementPlg_Dialog #txtFldDlgRetPlgEndOfAge").val("");
